...
!(function (e, t) {
    ...
    return (function (e) {
                    ...
                    return (
                        ...
                        (t.mixInto = function (e) {
                            ...
                            i.Mixin.mixInto.call(this, e),
                                ["bindBaseRenderHandlers", "queryScroll", "applyScroll", "triggerDayClick", "triggerSelect", "triggerExternalDrop", "handleResourceAdd", "handleResourceRemove"].forEach(function (r) {
                        ...
                        (t.prototype.triggerDayClick = function (e, t, r) {
                            ...
                            this.publiclyTrigger("dayClick", { context: t, args: [o.start, r, this, e.resourceId ? this.calendar.resourceManager.getResourceById(e.resourceId) : null] });
                        }),
                        (t.prototype.triggerSelect = function (e, t) {
                            var r = this.calendar.footprintToDateProfile(e);
                            this.publiclyTrigger("select", { context: this, args: [r.start, r.end, t, this, e.resourceId ? this.calendar.resourceManager.getResourceById(e.resourceId) : null] });
                        }),
                        (t.prototype.triggerExternalDrop = function (e, t, r, o, n) {
                            this.publiclyTrigger("drop", { context: r[0], args: [e.dateProfile.start.clone(), o, n, e.getResourceIds()[0], this] }),
                                t && this.publiclyTrigger("eventReceive", { context: this, args: [e.buildInstance().toLegacy(), this] });
                        }),
                        t
                    );
                })(i.Mixin);
                            ...
                            for (var t = this.resourceCnt, r = this.datesAboveResources ? this.sliceRangeByDay(e.unzonedRange) : this.sliceRangeByRow(e.unzonedRange), o = [], i = 0, s = r; i < s.length; i++)
                                for (var l = s[i], c = 0; c < t; c++) {
                                    ...
                                    if (!(e instanceof a["default"]) || e.resourceId === u.id) {
                                        ...
                                        (d.resource = u),
                                            this.isRTL
                                                ? ((d.leftCol = this.indicesToCol(c, l.lastRowDayIndex)), (d.rightCol = this.indicesToCol(c, l.firstRowDayIndex)))
                                                : ((d.leftCol = this.indicesToCol(c, l.firstRowDayIndex)), (d.rightCol = this.indicesToCol(c, l.lastRowDayIndex))),
                                            o.push(d);
                                    }
                                }
                            return o;
                ...
                y = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.componentFootprintToSegs = function (e) {
                            ...
                            if (this.computeDateSnapCoverage(t) < this.computeDateSnapCoverage(r)) {
                                ...
                                if (i) {
                                    var s = i.getStart(),
                                        a = i.getEnd();
                                    n.push({ start: s, end: a, isStart: i.isStart && this.isValidDate(s), isEnd: i.isEnd && this.isValidDate(a.clone().subtract(1)) });
                                }
                            }
                            return n;
                        }),
                        ...
                        (t.prototype.updateGridDates = function () {
                            for (var e = -1, t = 0, r = [], o = [], n = this.normalizedUnzonedStart.clone(); n < this.normalizedUnzonedEnd;)
                                this.isValidDate(n) ? (e++ , r.push(e), o.push(t)) : r.push(e + 0.5), n.add(this.snapDuration), t++;
                        ...
                        (t.prototype.renderSkeleton = function () {
                            this.el.addClass("fc-timeline"),
                                ...
                                (this.timeHeadScroller = new a["default"]({ overflowX: "clipped-scroll", overflowY: "hidden" })),
                                ...
                                (this.slatContainerEl = n('<div class="fc-slats"/>').appendTo(this.timeBodyScroller.canvas.bgEl)),
                                (this.segContainerEl = n('<div class="fc-event-container"/>').appendTo(this.timeBodyScroller.canvas.contentEl)),
                                (this.bgSegContainerEl = this.timeBodyScroller.canvas.bgEl),
                                (this.timeBodyBoundCache = new s.CoordCache({ els: this.timeBodyScroller.canvas.el, isHorizontal: !0, isVertical: !0 })),
                                (this.timeScrollJoiner = new c["default"]("horizontal", [this.timeHeadScroller, this.timeBodyScroller])),
                                ...
                                this.isRTL ? (this.eventTitleFollower.containOnNaturalRight = !0) : (this.eventTitleFollower.containOnNaturalLeft = !0),
                        ...
                        (t.prototype.renderDates = function (e) {
                            g.initScaleProps(this),
                                ...
                                this.isTimeScale && (this.normalizedUnzonedStart.add(e.minTime), this.normalizedUnzonedEnd.subtract(1, "day").add(e.maxTime)),
                                (this.normalizedUnzonedRange = new s.UnzonedRange(this.normalizedUnzonedStart, this.normalizedUnzonedEnd));
                            var t = [],
                            ...
                            this.timeHeadScroller.canvas.contentEl.html(o.headHtml),
                                ...
                                (this.slatInnerCoordCache = new s.CoordCache({ els: this.slatEls.find("> div"), isHorizontal: !0, offsetParent: this.timeBodyScroller.canvas.el }));
                            for (var n = 0; n < this.slotDates.length; n++) (r = this.slotDates[n]), this.publiclyTrigger("dayRender", { context: this, args: [r, this.slatEls.eq(n), this] });
                        ...
                        (t.prototype.renderSlatHtml = function () {
                            ...
                            for (var T = 0; T < l.length; T++) {
                                ...
                                for (var x = 0, M = r; x < M.length; x++) {
                                    ...
                                    e.weekStart && z.push("fc-em-cell"),
                                        ...
                                        (C += '<th id="data-head" class="' + z.join(" ") + ' data-table-header" data-date="' + e.date.format() + '"' + (e.colspan > 1 ? ' colspan="' + e.colspan + '"' : "") + '><div class="fc-cell-content" style=" height:30px !important;" >'+
                                        '<table style="border:none; border-collapse: collapse;">' +
                                            '<tr style="border:none; background-color:var(--date_color);"><th colspan="1" style="border:none;">' + e.spanHtml + '</th></tr>' +
                                       '</table ></div></th>');

                                    //'<tr style="border:none; font-weight:normal !important;"><td data-date="' + e.date.format() + '" class="totalAvailableRooms" colspan="2" style="border:none; background-color:var(--available_room);" title="Total Avialble Rooms"  data-placement="bottom"></td></tr>' +
                                        //'<tr style="font-weight:normal !important;"><td data-date="' + e.date.format() + '" class="complentryRooms cursor-pointer" style="background-color:var(--table_1);" title="Complementory Rooms" data-placement="bottom"></td><td data-date="' + e.date.format() + '" class="paidRooms" style="background-color:var(--table_2);" title="Paid Rooms" data-placement="bottom"></td></tr>' +
                                       // '<tr style="border:none; font-weight:normal !important;"><td data-date="' + e.date.format() + '" class="room-rate" colspan="2" style="border:none; background-color:var(--rate_color); font-size:11px;" title="ARR" data-placement="bottom"></td></tr>' +
                            ...
                            C += "</tbody></table>";
                            var F = '<table class="newtable' + n.getClass("tableGrid") + '">';
                            F += "<colgroup>";
                        ...
                        (t.prototype.buildCellObject = function (e, t, r) {
                            e = e.clone();
                            var o = this.buildGotoAnchorHtml({ date: e, type: r, forceOff: !r }, { class: "fc-cell-text" }, s.htmlEscape(t));
                            //console.log(e);
                        ...
                        (t.prototype.slatCellHtml = function (e, t) {
                            ...
                            return (
                                this.isTimeScale ? ((r = []), r.push(s.isInt(s.divideRangeByDuration(this.normalizedUnzonedStart, e, this.labelInterval)) ? "fc-major" : "fc-minor")) : ((r = this.getDayClasses(e)), r.push("fc-day")),
                        ...
                        (t.prototype.renderNowIndicator = function (e) {
                            ...
                            if (((e = this.normalizeGridDate(e)), this.normalizedUnzonedRange.containsDate(e))) {
                                ...
                                t.push(n("<div class='fc-now-indicator fc-now-indicator-arrow'></div>").css(o).appendTo(this.timeHeadScroller.canvas.el)[0]),
                                    t.push(n("<div class='fc-now-indicator fc-now-indicator-line'></div>").css(o).appendTo(this.timeBodyScroller.canvas.el)[0]);
                            }
                        ...
                        (t.prototype.queryHit = function (e, t) {
                            ...
                            if (n.isPointInBounds(e, t)) {
                                ...
                                if (null != i) {
                                    ...
                                    return { snap: l, component: this, left: c, right: u, top: n.getTopOffset(0), bottom: n.getBottomOffset(0) };
                                }
                            }
                        }),
                ...
                return (
                    ...
                    (e.prototype.update = function () {
                        for (
                            ...
                            (t = c[l]), (n = Math.max(n, t.left)), (i = Math.max(i, t.right)), (s = Math.max(s, t.top)), (a = Math.max(a, t.bottom));
                        for (r = 0; r < this.scrollers.length; r++) (e = this.scrollers[r]), (t = o[r]), e.canvas.setGutters("horizontal" === this.axis ? { left: n - t.left, right: i - t.right } : { top: s - t.top, bottom: a - t.bottom });
                    }),
                    e
                );
            })();
        ...
        function (e, t, r,event) {
            var reservationDetail = {};
            var reservation = {};
            //reservationDetail = JSON.parse(event.description);
            reservation = reservationDetail[0];
                ...
                c = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.fgSegHtml = function (e, t) {
                            ...
                            var reservationDetail = {};
                            var reservation = {};
                            reservationDetail = JSON.parse(r.miscProps.description);
                            reservation = reservationDetail[0];
                            var grouping = "";

                            $('.main-reservation').hide();
                            //$('.main-reservation').each(function (index, item) {

                            //    $(reservation).each(function (index1, item1) {
                            //        console.log(item1.IsMainGuest);
                            //        if (item1.IsMainGuest == 1) {
                            //            //console.log(reservation.IsMainGuest);
                            //            $(item).find('.main-reservation').show();
                            //        } else {
                            //            $(item).find('.main-reservation').hide();

                            //        }
                            //    });
                            //});

                            if (reservation.BookingMethod=="OOO") {
                                return ('<a  data-toggle="tooltip" data-placement="right" title="' + r.title + '"class="' +
                                    s.join(" ") +
                                    '" style="' +
                                    a.cssToStr(this.getSkinCss(e.footprint.eventDef)) +
                                    '"' +
                                    (r.url ? ' href="' + a.htmlEscape(r.url) + '"' : "") +
                                    '><div class="fc-content cursor-pointer fc-ooo-content"><div class="booking-method" id="image-container" style="position:absolute; margin-left:2px;"> </div>' +
                                    (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>" : "") +
                                    '<span class="fc-title reservation-number" style="margin-left:2px; font-weight:200; z-index:500000;">' +
                                    (r.title ? a.htmlEscape(r.title) : "&nbsp;") +
                                    '</span></div>' +
                                    //'<span class="top_span main-reservation" id="mainReservation" style="margin-left:-1px; position: absolute; width:13px;margin-top: -35px; z-index: 5000000 !important;"  data-width="" data-href="" data-title=""><img src="../../Images/assets/crown.png" alt="crown" /></span>' +
                                    (n
                                ...
                                return ('<a  data-toggle="tooltip" data-placement="right" title="' + r.title + '"class="' +
                                    ...
                                    '"' +
                                    (r.url ? ' href="' + a.htmlEscape(r.url) + '"' : "") +
                                    '><div class="fc-content cursor-pointer"><div class="booking-method" id="image-container" style="position:absolute; margin-left:2px;"> <img src="../../Images/assets/' + reservation.BookingMethod + '.png" style="width:18px;" alt="Booking" /></div>' +
                                    (l ? '<span class="fc-time">' + a.htmlEscape(l) + "</span>" : "") +
                                    '<span class="fc-title reservation-number" style="margin-left:15px; font-weight:200; z-index:500000;">' +
                                    (r.title ? a.htmlEscape(r.title) : "&nbsp;") +
                                    '</span></div><div style="position: absolute;display:inline-block; float:right;">' +
                                    //'<span class="top_span main-reservation" id="mainReservation" style="margin-left:-1px; position: absolute; width:13px;margin-top: -35px; z-index: 5000000 !important;"  data-width="" data-href="" data-title=""><img src="../../Images/assets/crown.png" alt="crown" /></span>' +
                                    '<span class="top_span reservation-level_reservation_chart" id="reservatonLevelReservationChart" style="margin-left:-1px; position: absolute; width:13px;margin-top: -35px; z-index: 5000000 !important;"  data-width="" data-href="" data-title=""><img src="../../Images/assets/' + reservation.ResLevel + '.png" alt="home" /></span>' +
                                    '<span class="top_span is-group_reservation_chart"  style="float:right; position: absolute; width:13px; margin-left:15px; margin-top: -35px; z-index: 5000000;"><img src="../../Images/assets/' + reservation.IsGroup + '.png" alt="Users" /></span>' +
                                    '<span class="top_span dollar-mark_reservation_chart" id="btnManFolioReservationChart" style="position: absolute; width:13px; margin-top: -35px; z-index: 5000000 !important; margin-left:31px" data-width="" data-href="" data-title=""><img src="../../Images/assets/dollar.png" alt="Dollar mark" /></span></div><div class="fc-bg" />' +
                                    (n
                                        ? '<div class="fc-resizer fc-start-resizer"></div>'
                                        : "") +
                                    (i ? '<div class="fc-resizer fc-end-resizer"></div>' : "") +
                ...
                a = (function (e) {
                    ...
                    return (
                        ...
                        (t.mixInto = function (e) {
                            var t = this;
                            i.Mixin.mixInto.call(this, e),
                                ["updateDayTableCols", "computeColCnt", "getColDayIndex", "renderHeadTrHtml", "renderBgCellsHtml", "renderBusinessHours", "allowCrossResource"].forEach(function (r) {
                                    e.prototype[r] = t.prototype[r];
                                });
                        }),
                        ...
                        (t.prototype.processHeadResourceEls = function (e) {
                            ...
                            e.find(".fc-resource-cell").each(function (e, r) {
                                var o;
                                (o = t.datesAboveResources ? t.getColResource(e) : t.flattenedResources[t.isRTL ? t.flattenedResources.length - 1 - e : e]), t.publiclyTrigger("resourceRender", { context: o, args: [o, n(r), n(), t.view] });
                            });
                        }),
                ...
                a = (function (e) {
                    function t(t) {
                        ...
                        return (
                            ...
                            "clipped-scroll" === r.overflowX && ((r.overflowX = "scroll"), (r.isHScrollbarsClipped = !0)),
                            "clipped-scroll" === r.overflowY && ((r.overflowY = "scroll"), (r.isVScrollbarsClipped = !0)),
                            r
                        );
                    }
                    return (
                        ...
                        (t.prototype.updateSize = function () {
                            ...
                            return (
                                ...
                                e.css(r),
                                e.toggleClass("fc-no-scrollbars", (this.isHScrollbarsClipped || "hidden" === this.overflowX) && (this.isVScrollbarsClipped || "hidden" === this.overflowY) && !(t.top || t.bottom || t.left || t.right))
                            );
                        }),
                    ...
                    return (
                        ...
                        (e.prototype.updateViewport = function () {
                            var e = this.scroller,
                                ...
                                r = e.getScrollTop();
                            return (this.viewportRect = { left: t, right: t + e.getClientWidth(), top: r, bottom: r + e.getClientHeight() });
                        }),
        ...
        function (e, t, r) {
            ...
            function d(e, t) {
                return { left: Math.min(e.left, t.left), right: Math.max(e.right, t.right), top: Math.min(e.top, t.top), bottom: Math.max(e.bottom, t.bottom) };
            }
            Object.defineProperty(t, "__esModule", { value: !0 });
            var h = r(0),
                p = (function () {
                    ...
                    return (
                        ...
                        (e.prototype.cacheDimensions = function () {
                            ...
                            o.containOnNaturalLeft && (l.left = s.left),
                                ...
                                o.isHFollowing && n(l) - n(s) >= c && ((r = "center" === this.el.css("text-align")), (e = !0)),
                            ...
                            if (this.isEnabled)
                                if (this.rect)
                                    if (this.doAbsolute && !this.follower.isForcedRelative)
                                        ...
                                        this.unabsolutize(), this.el.toggleClass("fc-following", Boolean(e || t)).css({ top: e, left: t });
                                    }
                        ...
                        (t.prototype.attachSegEls = function (e, t) {
                            if (t.length) {
                                ...
                                for (var o = n('<div class="fc-' + r + '-container" />').appendTo(this.component.bgSegContainerEl), i = 0, s = t; i < s.length; i++) {
                                    ...
                                    a.el.css({ left: (a.left = l.left), right: -(a.right = l.right) }), a.el.appendTo(o);
                                }
                                return o;
                            }
                        }),
                    ...
                    return (
                        ...
                        (t.prototype.processResourceOptions = function () {
                            ...
                            if (((n[0].isMain = !0), i.length)) (s = i), (l = !0);
                                ...
                                p && ((c = !0), s.push({ field: p, text: this.opt("resourceGroupText"), render: this.opt("resourceGroupRender") }));
                            }
                        ...
                        (t.prototype.renderSkeleton = function () {
                            ...
                            (this.timeBodyTbodyEl = r.find("tbody")),
                                (this.tbodyHash = { spreadsheet: this.spreadsheet.tbodyEl, event: this.timeBodyTbodyEl }),
                                (this.resourceScrollJoiner = new l["default"]("vertical", [this.spreadsheet.bodyScroller, this.timeBodyScroller])),
                        ...
                        (t.prototype.prepareHits = function () {
                            ...
                            (this.shownEventRows = t), (this.rowCoordCache = new a.CoordCache({ els: r, isVertical: !0 })), this.rowCoordCache.build();
                        }),
                        ...
                        (t.prototype.insertResource = function (e, t) {
                            ...
                            t || (e.parent ? (t = this.getResourceRow(e.parent.id)) : e.parentId && (t = this.getResourceRow(e.parentId))),
                                t ? this.insertRowAsChild(o, t) : this.insertRow(o),
                                this.addChild(o),
                                (this.resourceRowHash[e.id] = o),
                                e.businessHourGenerator && (this.indiBizCnt++ , this.isIndiBizRendered && (o.businessHourGenerator = e.businessHourGenerator), this.updateIndiBiz());
                ...
                s = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.renderRowspan = function () {
                            ...
                            this.rowspan
                                ? (this.groupTd || (this.groupTd = n('<td class="' + t.getClass("widgetContent") + '"/>').append(this.renderGroupContentEl())),
                                ...
                                : (this.groupTd && (this.groupTd.remove(), (this.groupTd = null)), (this.leadingTr = null));
                        }),
                ...
                c = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.renderEventSkeleton = function (e) {
                            ...
                            e.html('<td class="' + t.getClass("widgetContent") + '"> <div> <div class="fc-event-container" /> </div> </td>'),
        ...
        function (e, t, r) {
            ...
            if (((o.schedulerVersion = n), 12 !== o.internalApiVersion))
                throw new Error("v" + n + " of FullCalendar Scheduler is incompatible with v" + o.version + " of the core.\nPlease see http://fullcalendar.io/support/ for more information.");
        },
        function (e, t, r) {
            Object.defineProperty(t, "__esModule", { value: !0 });
            var o = r(0),
                ...
                l = (function (e) {
                    ...
                    return (
                        ...
                        (t.prototype.bindHandlers = function () {
                            return this.listenTo(this.scrollEl, { scroll: this.reportScroll, touchstart: this.reportTouchStart, touchend: this.reportTouchEnd });
                        }),
            ...
            function l(e) {
                ...
                switch (("week" !== n || i || (n = "day"), n)) {
                    ...
                    case "week":
                        ...
                        break;
                    case "day":
                        e.currentRangeAs("years") > 1 ? (s = e.opt("monthYearFormat")) : e.currentRangeAs("months") > 1 && (s = "MMMM"), i && (t = e.opt("weekFormat")), (r = "MMM D");
                        break;
                    case "hour":
                ...
                d = (function () {
                    ...
                    return (
                        (e.prototype.renderSkeleton = function () {
                            ...
                            (this.headScroller = new i["default"]({ overflowX: "clipped-scroll", overflowY: "hidden" })),
                                ...
                                this.bodyScroller.canvas.contentEl.html('<div class="fc-rows"> <table class="' + e.getClass("tableGrid") + '">' + this.colGroupHtml + "<tbody/> </table> </div>"),
                                (this.tbodyEl = this.bodyScroller.canvas.contentEl.find("tbody")),
                                this.el.append(this.bodyScroller.el),
                                (this.scrollJoiner = new a["default"]("horizontal", [this.headScroller, this.bodyScroller])),
                        ...
                        (e.prototype.renderHeadHtml = function () {
                            ...
                            for (var l = 0; l < t.length; l++) {
                                ...
                                r +=
                                    ...
                                    (a.isMain ? '<span class="fc-expander-space"><span class="fc-icon"></span></span>' : "") +
                    ...
                    return (
                        ...
                        (t.prototype.renderSkeleton = function () {
                            e.prototype.renderSkeleton.call(this),
                                ...
                                this.eventsPayload && s["default"].prototype.executeEventRender.call(this, this.eventsPayload),
                                this.businessHourGenerator && this.view.dateProfile && s["default"].prototype.renderBusinessHours.call(this, this.businessHourGenerator),
                                this.view.publiclyTrigger("resourceRender", { context: this.resource, args: [this.resource, this.getTr("spreadsheet").find("> td"), this.getTr("event").find("> td"), this.view] });
                        }),
                        (t.prototype.removeElement = function () {
                            e.prototype.removeElement.call(this),
                                this.eventsPayload && s["default"].prototype.executeEventUnrender.call(this, this.eventsPayload),
                                this.businessHourGenerator && s["default"].prototype.unrenderBusinessHours.call(this, this.businessHourGenerator);
                        }),
                        ...
                        (t.prototype.renderSpreadsheetSkeleton = function (e) {
                            for (var t = this.view.calendar.theme, r = this.resource, o = 0, s = this.view.colSpecs; o < s.length; o++) {
                                ...
                                titleDetails = r.eventClassName[0];

                                //editablepart
                                    if (!a.group) {
                                        var l = a.field ? r[a.field] || null : r,
                                            c = "function" == typeof a.text ? a.text(r, l) : l,
                                            //u = n('<div class="fc-cell-content">' + (a.isMain ? this.renderGutterHtml() : "") + '<span class="fc-cell-text" style="font-size:16px"><b>' + (c ? i.htmlEscape(c) : "&nbsp;") + '  </b><span style="font-size:13px">' + titleDetails.RoomCatAndType + '</span></span><span style="width:18px;float:right"><img src="../../Images/assets/' + titleDetails.ConnectedRoomIcon +'.png" alt="standard" /></span><span style="width:18px; float:right"><img src="../../Images/assets/' + titleDetails.SingleRoomIcon + '.png" alt="standard" /></span></div>');
                                            u = n('<div class="fc-cell-content">' + (a.isMain ? this.renderGutterHtml() : "") + '<span class="fc-cell-text" style="font-size:16px"><b>' + (c ? i.htmlEscape(c) : "&nbsp;") + '  </b><span style="font-size:13px">' + titleDetails.RoomCatAndType + '</span></span><span style="width:18px;float:right"></span><span style="width:18px; float:right"></span></div>');
        ...
        function (e, t, r) {
            ...
            var o = r(2),
                ...
                s = r(49),
                a = r(6),
                l = { constructed: n.Calendar.prototype.constructed, buildSelectFootprint: n.Calendar.prototype.buildSelectFootprint };
                    ...
                    return (
                        ...
                        (t.prototype.fetchResourceInputs = function (e, r, o) {
                            ...
                            switch (("string" === n.type(a) && (a = { url: a }), n.type(a))) {
                                ...
                                case "object":
                                    s.pushLoading();
                                    var c = {};
                                    r && o && ((c[s.opt("startParam")] = r.format()), (c[s.opt("endParam")] = o.format()), l && "local" !== l && (c[s.opt("timezoneParam")] = l)),
                        ...
                        (t.prototype.buildResource = function (e) {
                            ...
                            return (
                                ...
                                e.businessHours && (o.businessHourGenerator = new i.BusinessHourGenerator(e.businessHours, this.calendar)),
        ...
        function (e, t, r) {
            ...
            var n = r(0),
                i = r(52),
                s = { setElement: n.View.prototype.setElement, removeElement: n.View.prototype.removeElement, triggerViewRender: n.View.prototype.triggerViewRender };
        ...
        function (e, t, r) {
            Object.defineProperty(t, "__esModule", { value: !0 });
            var o = r(0),
                n = { computeEventStartResizeMutation: o.EventResizing.prototype.computeEventStartResizeMutation, computeEventEndResizeMutation: o.EventResizing.prototype.computeEventEndResizeMutation };
        ...
        function (e, t, r) {
            ...
            var o = r(2),
                n = r(0),
                i = r(19),
                s = { applyMiscProps: n.EventDef.prototype.applyMiscProps, clone: n.EventDef.prototype.clone, toLegacy: n.EventDef.prototype.toLegacy };
            ...
            (o.EventDefMutation.prototype.oldResourceId = null),
                ...
                (o.EventDefMutation.prototype.mutateSingle = function (e) {
                    var t = n.apply(this, arguments),
                        r = null;
                    return (
                        this.oldResourceId && e.hasResourceId(this.oldResourceId) && ((r = e.getResourceIds()), e.removeResourceId(this.oldResourceId), e.addResourceId(this.newResourceId)),
                        function () {
                            t(), r && (e.resourceIds = r);
                        }
                    );

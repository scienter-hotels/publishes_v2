...
if ("undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), function() {
  ...
  if ("undefined" == typeof DayPilot.$) {
   ...
   DayPilot.Canvas = function(e, t, i, n, a) {
     ...
     "dayNamesShort": ["N", "Pn", "Wt", "Œr", "Cz", "Pt", "So"],
     ...
     "dayNames": ["duminicã", "luni", "mar?i", "miercuri", "joi", "vineri", "sâmbãtã"],
     ...
     "dayNames": ["nede¾a", "pondelok", "utorok", "streda", "štvrtok", "piatok", "sobota"],
     ...
     "dayNamesShort": ["sö", "ma", "ti", "on", "to", "fr", "lö"],
     ...
     "dayNames": ["Pazar", "Pazartesi", "Sali", "Çarºamba", "Perºembe", "Cuma", "Cumartesi"],
     "dayNamesShort": ["Pz", "Pt", "Sa", "Ça", "Pe", "Cu", "Ct"],
     "monthNames": ["Ocak", "ªubat", "Mart", "Nisan", "Mayis", "Haziran", "Temmuz", "Agustos", "Eylül", "Ekim", "Kasim", "Aralik", ""],
     "monthNamesShort": ["Oca", "ªub", "Mar", "Nis", "May", "Haz", "Tem", "Agu", "Eyl", "Eki", "Kas", "Ara", ""],
     "timePattern": "HH:mm",
     "datePattern": "d.M.yyyy",
     "dateTimePattern": "d.M.yyyy HH:mm",
     "timeFormat": "Clock24Hours",
  ...
  if ("undefined" == typeof DayPilot.Calendar) {
   DayPilot.Calendar = function(t, i) {
    ...
    this.eventResizePostBack = function(e, t, i, n) {
     ...
     var a = {};
     a.e = e,
      a.newStart = t, a.newEnd = i, this.F("EventResize", n, a)
     ...
     this.nav.scroll.style.zoom = 1, this.nav.scroll.setAttribute("data-id", "nav.scroll"),
      this.nav.scroll.style.position = "absolute", this.nav.scroll.style.left = "0px", this.nav.scroll.style.right = "0px", this.nav.scroll.style.top = this.Ea() + "px";
     var t = this.fc();
    ...
    o.active = !1, o.start = null, o.timeout = null, o.startcell = null, this.Yb.getCellCoords = function(e) {
     ...
     if (this.od(e), this.ld(), "function" == typeof a.onAfterRender) {
      var t = {};
      t.isUpdate = !0, t.data = null, a.onAfterRender(t)
     }
    }, this.nd = function() {
     ...
     0 === l && (d = s);
     var c = {};
     return c.cut = !1, c.top = this.pd(r), c.boxTop = this.pd(s), c.boxBottom = this.pd(d), this.t.pixels[n + "_" + i] = c, c
    }, this.pd = function(e) {
     return Math.floor(this.cellHeight * e / (6e4 * this.cellDuration))
    }, this.md = function() {
     this.startDate = new DayPilot.Date(this.startDate).getDatePart(), this.qd = r.allDayEventHeight() + 4
    }, this.ea = function() {
     var e = this.Ea(),
      t = this.bc();
    ...
    r.locale = function() {
     ...
     var e = a.rd("_alldayevent_height").height;
     ...
     var e = a.rd("_header_height").height;
    ...
    var l = this.sd;
    l.td = null, l.ud = null, l.generate = function(e, t) {
        ...
        if (a.showAllDayEvents) {
         ...
         DayPilot.list(a.xa).each(function(i) {
          ...
          DayPilot.list(e).each(function(e) {
           ...
           k.x += f.left, k.w -= f.left + f.right,
            k.y += f.top, k.h -= f.top + f.bottom, o.fillRect(D, g.backColor), o.text(k, g.text, {
             "size": g.fontSize,
             "family": g.fontFamily,
             "style": g.fontStyle
     ...
     this.xd(), this.md(), this.ba(), this.dc(), this.fa(), this.ga(), this.ja(), this.ma(), this.Ec(), this.Zc(), this.S(), this.na(), e.register(this), this.R(), this.oa(), this.Wc(), this.ta(), this.H("Init")
    }, this.init = function() {
     if (this._b(), this.xd(), !this.nav.top.dp) {
      var t = this.vd();
      return a.cssOnly || (a.cssOnly = !0, DayPilot.Util.log("DayPilot: cssOnly = false mode is not supported since DayPilot Pro 8.0.")), t ? (this.yd(), void(this.A = !0)) : (this.md(), this.ba(), this.ca(), this.events.list || (this.events.list = []), this.da(), this.dc(), this.fa(), this.ga(), this.ja(), this.pa(), this.na(), this.ma(), this.Ec(), this.Zc(), this.S(), e.register(this), this.ea(), this.qa(), this.ra(), this.R(), this.messageHTML && this.message(this.messageHTML), this.oa(), this._(null, !1), this.Wc(), this.ta(), this.A = !0, this.zd(), this)
     }
    }, this.Ad = null, this.od = function(e) {
     if (e) {
      var t = {
       "events": {
        "preInit": function() {
     ...
     return a.A
    }, this.internal.invokeEvent = this.Sa, this.internal.eventMenuClick = this.ab, this.internal.timeRangeMenuClick = this.bb, this.internal.bubbleCallBack = this.$a, this.internal.findEventDiv = this.jd, this.internal.eventDeleteDispatch = this.Ra, this.internal.touch = this.Yb, this.Init = this.init, this.od(i)
   };
   var e = {};
  ...
  if ("undefined" == typeof DayPilot.Gantt) {
   ...
   DayPilot.Gantt = function(t, i) {
     ...
     o.timeout = null, o.update = function() {
      ...
      return l.translate(), l.Gd(), l.Hd(), this.Jd(), a.init(), this.A = !0, this.zd(), this
     ...
     s.keys = {}, s.sheet = null, l.Td = function(e) {
      ...
      return n.A
     }, this.internal.rowObjectForTaskData = l.Qd, this.internal.loadOptions = n.od, this.kd = {}, this.kd.scope = null, this.kd.notify = function() {
  ...
  if ("undefined" == typeof DayPilot.Kanban) {
   ...
   DayPilot.Kanban = function(t, i) {
     ...
     d.active = null, d.div = null, d.update = function() {
      ...
      this.Ad = t, n.columns.list = [], n.swimlanes.list = [], n.cards.list = [];
      for (var i in e)
       if (t[i]) {
        var a = t[i];
        a.data = e[i], a.preInit && a.preInit()
     ...
     }, this.internal = {}, this.internal.loadOptions = n.od, this.od(i), this.Vc = function() {
      var e = dp.nav.top;
...
if ("undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), function() {
  if ("undefined" == typeof DayPilot.Menu) {
   ...
   t.mouse = null, t.menu = null, t.handlersRegistered = !1, t.hideTimeout = null, t.waitingSubmenu = null, DayPilot.Menu = function(i) {
    var n = this,
     a = null;
    this.v = "2018.1.3158", this.zIndex = 10, this.cssClassPrefix = "menu_default", this.cssOnly = !0, this.menuTitle = null, this.showMenuTitle = !1, this.hideOnMouseOut = !1, this.theme = null, this.onShow = null, this.n = function() {}, i && DayPilot.isArray(i) && (this.items = i), this.show = function(i, o) {
     var o = o || {},
      r = null;
  ...
  if ("undefined" == typeof DayPilot.Month) {
   ...
   DayPilot.Month = function(i, n) {
     ...
     l.clearCache = function() {
      ...
      var e = a.rd("_event_height").height;
     ...
     var s = this.sd;
     s.td = null, s.ud = null, s.generate = function(e, t) {
      "object" == typeof e && (t = e, e = null);
      var t = t || {},
       e = e || t.format || "svg",
       i = t.scale || 1;
      ...
      var e = a;
      e.nav.top && (e.mf(), e.O(), e.nav.top.removeAttribute("style"), e.nav.top.removeAttribute("class"), e.nav.top.innerHTML = "", e.nav.top.dp = null, e.nav.top.onmousemove = null, e.nav.top.ontouchstart = null, e.nav.top.ontouchmove = null, e.nav.top.ontouchend = null, e.nav.top = null, DayPilot.ue(window, "resize", e.R), t.unregister(e))
     }, this.Zc = function() {
      ...
      this.xd(), this.He(), this.dc(), this.Je(), this.la(), this.Zc(), this.ta(), this.H("Init"), t.register(this)
     }, this.init = function() {
      if (this._b(), this.xd(), !this.nav.top.dp) {
       var e = l.loadFromServer();
       return a.cssOnly || (a.cssOnly = !0, window.console && window.console.log && window.console.log("DayPilot: cssOnly = false mode is not supported since DayPilot Pro 8.0.")), e ? (this.yd(), void(this.A = !0)) : (this.He(), this.da(), this.dc(), this.Je(), this.pa(), this.qa(), this.la(), this.Zc(), this.messageHTML && this.message(this.messageHTML), this._(null, !1), this.ta(), t.register(this), this.A = !0, this.zd(), this)
      }
     }, this.Ad = null, this.od = function(e) {
      if (e) {
       var t = {
      ...
      return a.A
     }, this.internal.invokeEvent = this.Sa, this.internal.eventMenuClick = this.ab, this.internal.timeRangeMenuClick = this.bb, this.internal.bubbleCallBack = this.$a, this.internal.findEventDiv = this.jd, this.internal.adjustEndIn = this.Me, this.Init = this.init, this.od(n)
  ...
  if ("undefined" == typeof DayPilot.Navigator) {
   DayPilot.Navigator = function(e, t) {
     ...
     this.id = e, this.api = 2, this.isNavigator = !0, this.autoFocusOnClick = !0, this.weekStarts = "Auto", this.selectMode = "day", this.titleHeight = 20, this.dayHeaderHeight = 20, this.bound = null, this.cellWidth = 20, this.cellHeight = 20, this.cssOnly = !0, this.cssClassPrefix = "navigator_default", this.freeHandSelectionEnabled = !1, this.selectionStart = (new DayPilot.Date).getDatePart(), this.selectionEnd = null, this.selectionDay = null, this.showMonths = 1, this.skipMonths = 1, this.command = "navigate", this.year = (new DayPilot.Date).getYear(), this.month = (new DayPilot.Date).getMonth() + 1, this.showWeekNumbers = !1, this.weekNumberAlgorithm = "Auto", this.rowsPerMonth = "Six", this.orientation = "Vertical", this.locale = "en-us", this.visible = !0, this.timeRangeSelectedHandling = "Bind", this.visibleRangeChangedHandling = "Enabled", this.onVisibleRangeChange = null, this.onVisibleRangeChanged = null, this.onTimeRangeSelect = null, this.onTimeRangeSelected = null, this.nav = {}, this.t = {}, this.of = function() {
      ...
      for (var A = 0; A < 7; A++) {
       ...
       for (var x = 0; x < u; x++) {
        ...
        z.style.position = "absolute", this.cssOnly ? z.className = P.getTime() === f.getTime() && E ? this.q("_todaybox") : this.q("_daybox") : z.className = P.getTime() === f.getTime() && E ? this.q("todaybox") : this.q("daybox"), i.qf(z, "cell_box"), z.style.left = "0px", z.style.top = "0px", z.style.right = "0px", z.style.bottom = "0px", R.appendChild(z);
        var L = null;
        ...
        if (L && DayPilot.Util.addClass(R, L.cssClass || L.css), E || r && M || l && H) {
         var I = document.createElement("div");
         I.innerHTML = P.getDay(), I.style.position = "absolute", I.style.left = "0px", I.style.top = "0px", I.style.right = "0px", I.style.bottom = "0px", i.qf(I, "cell_text"), R.style.cursor = "pointer", R.isClickable = !0, L && L.html && (I.innerHTML = L.html), R.appendChild(I)
        }
        R.setAttribute("unselectable", "on"), R.onclick = this.yf, g.appendChild(R), T && (i.zf(g, A, x), this.selected.push(R))
       }
      }
      var F = document.createElement("div");
      F.style.position = "absolute", F.style.left = "0px", F.style.top = y - 2 + "px", F.style.width = 7 * o.cellWidth() + this.pf() + "px", F.style.height = "1px", F.style.fontSize = "1px", F.style.lineHeight = "1px", this.cssOnly ? F.className = this.q("_line") : F.className = this.q("line"), g.appendChild(F), this.months.push(n)
      ...
      if (i) {
       ...
       (this.selectionStart < this.Ef() || this.selectionStart >= this.Ff()) && (l = this.selectionStart.firstDayOfMonth()), l.toStringSortable() !== this.startDate.toStringSortable() && (r = !0), this.startDate = l
      }
      this.Df(), this.Ie(), this.of(), this.Gf(), this.Bf(), this.Cf(), !n || a.equals(this.selectionStart) && o.equals(this.selectionEnd) || this.cb(), r && this.Hf()
     }, this.update = function() {
      i.cssOnly || (i.cssOnly = !0, DayPilot.Util.log("DayPilot: cssOnly = false mode is not supported since DayPilot Pro 8.0.")), this.Ie(), this.of(), this.Df(), this.Gf(), this.da(), this.Bf(), this.Cf(), this.visible ? this.show() : this.hide()
     ...
     this.yf = function(e) {
       ...
       switch (i.wf()) {
        ...
        case "day":
         if (i.autoFocusOnClick) {
          var l = r;
          if (r < i.Ef() || r >= i.Ff()) return void i.select(r)
         }
         var s = n.cells[a][o];
        ...
        case "week":
         if (i.autoFocusOnClick) {
          var l = n.cells[0][o].day,
           d = n.cells[6][o].day;
          if (l.firstDayOfMonth() === d.firstDayOfMonth() && (l < i.Ef() || d >= i.Ff())) return void i.select(r)
         }
      ...
      this.startDate = this.startDate.addMonths(e), this.Ie(), this.of(), this.Gf(), this.Cf(), this.Hf(), this.Bf()
     }, this.Ef = function() {
      ...
      var e = JSON.parse(e);
      i.items = e.Items, i.cells = e.Cells, i.cells ? i.update() : i.Bf()
     }, this.Gf = function() {
      for (var e = 0; e < this.showMonths; e++) {
       var t = this.Pf(e);
       this.Je(e, t)
     ...
     o.locale = function() {
      ...
      if (this.xd(), !this.root.dp) {
       i.cssOnly || (i.cssOnly = !0, DayPilot.Util.log("DayPilot: cssOnly = false mode is not supported since DayPilot Pro 8.0.")), this.Df(), this.of(), this.Gf(), this.da(), this.Bf(), this.S(), this.Rf(), this.Zc();
       return this.vd() && this.Hf(), this.A = !0, this
      }
     }, this.Rf = function() {
      i.nav.top.onmousedown = this.Lf, i.nav.top.onmousemove = this.Mf
     }, this.Zc = function() {
      ...
      if (n.start && n.end) {
       ...
       n.clear();
       var o = n.ordered();
       o.start = new a(o.start).nextVisible(), o.end = new a(o.end).previousVisible(), i.selectionDay = new a(o.start).date(), i.selectionStart = i.selectionDay, i.selectionEnd = new a(o.end).date(), n.start = null, n.end = null, i.Ie(), i.of(), i.Gf(), i.Bf(), i.Cf();
       i.cb({
        "mode": "freehand"
       })
      }
...
if ("undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), function() {
  ...
  if ("undefined" == typeof DayPilot.Scheduler) {
   ...
   DayPilot.Scheduler = function(e, o) {
    ...
    this.backendUrl = null, DayPilot.browser.ie && (this.scrollDelayCells = 100, this.scrollDelayFloats = 100), 1 === c.api && (this.onEventMove = function() {}, this.onEventResize = function() {}, this.onResourceExpand = function() {}, this.onResourceCollapse = function() {}), this.onEventClick = null, this.onEventClicked = null, this.onEventMove = null, this.onEventMoved = null, this.onEventMoving = null, this.onEventResize = null, this.onEventResized = null, this.onEventResizing = null, this.onEventRightClick = null, this.onEventRightClicked = null, this.onEventMouseOver = null, this.onEventMouseOut = null, this.onRowClick = null, this.onRowClicked = null, this.onTimeRangeClick = null, this.onTimeRangeClicked = null, this.onTimeRangeDoubleClick = null, this.onTimeRangeDoubleClicked = null, this.onTimeRangeSelect = null, this.onTimeRangeSelected = null, this.onTimeRangeSelecting = null, this.onTimeRangeRightClick = null, this.onTimeRangeRightClicked = null, this.onRowHeaderResized = null, this.onCellMouseOver = null, this.onCellMouseOut = null, this.onGridMouseDown = null, this.onBeforeCellRender = null, this.onBeforeEventRender = null, this.onBeforeTimeHeaderRender = null, this.onBeforeResHeaderRender = null, this.onBeforeRowHeaderRender = null, this.onBeforeCellExport = null, this.onBeforeEventExport = null, this.onBeforeTimeHeaderExport = null, this.onBeforeRowHeaderExport = null, this.onEventFilter = null, this.onRowFilter = null, this.onRectangleEventSelecting = null, this.onRectangleEventSelect = null, this.onRectangleEventSelected = null, this.onDimensionsChanged = null, this.onAfterUpdate = null, this.B = 0, this.Yf = -1, this.rowlist = DayPilot.list(), this.itline = DayPilot.list(), this.timeline = null, this.events = {}, this.cells = {}, this.elements = {}, this.elements.events = [], this.elements.bars = [], this.elements.text = [], this.elements.cells = [], this.elements.linesVertical = [], this.elements.separators = [], this.elements.range = [], this.elements.breaks = [], this.elements.links = [], this.elements.linkpoints = [], this.elements.rectangle = [], this.elements.hover = [], this.t = {}, this.t.cells = [], this.t.linesVertical = {}, this.t.linesHorizontal = {}, this.t.timeHeaderGroups = [], this.t.timeHeader = {}, this.t.pixels = [], this.t.breaks = [], this.t.events = [], this.clientState = {}, this.members = {}, this.members.obsolete = ["Init", "cleanSelection", "cssClassPrefix", "getHScrollPosition", "setHScrollPosition", "getVScrollPosition", "setVScrollPosition", "showBaseTimeHeader"], this.members.ignoreFilter = function(e) {
     ...
     if ("function" == typeof c.onCallBackResult) {
      ...
      if (i.result = e, i.preventDefault = function() {
       ...
       }, c.onCallBackResult(i), i.preventDefault.value) return c.Ya(), c.Z(), c.ta(), e.Message && c.message && c.message(e.Message), c._(e.CallBackData, !0), c.Zf(), void c.$f()
     }
     if (e.BubbleGuid) {
      var n = e.BubbleGuid,
       a = this.bubbles[n];
      return delete this.bubbles[n], c.Z(), "undefined" != typeof e.Result.BubbleHTML && a && a.updateView(e.Result.BubbleHTML, a), void c.Zf()
     }
     if ("undefined" != typeof DayPilot.Bubble && DayPilot.Bubble.hideActive(), "undefined" != typeof e.ClientState && (null === e.ClientState ? c.clientState = {} : c.clientState = e.ClientState), "None" === e.UpdateType) return c.Z(), c.Zf(), e.Message && c.message(e.Message), void c._(e.CallBackData, !0);
     if (e.VsUpdate) {
      var o = document.createElement("input");
     ...
     "undefined" != typeof e.TagFields && (c.tagFields = e.TagFields), "undefined" != typeof e.SortDirections && (c.sortDirections = e.SortDirections), c.t.drawArea = null, "Full" === e.UpdateType && (c.resources = e.Resources, c.colors = e.Colors, c.palette = e.Palette, c.dirtyColors = e.DirtyColors, c.cellProperties = e.CellProperties, c.cellConfig = e.CellConfig, c.separators = e.Separators, c.timeline = e.Timeline, c.timeHeader = e.TimeHeader, c.timeHeaders = e.TimeHeaders, "undefined" != typeof e.Links && (c.links.list = e.Links), "undefined" != typeof e.RowHeaderColumns && (c.rowHeaderColumns = e.RowHeaderColumns), c.startDate = e.StartDate ? new DayPilot.Date(e.StartDate) : c.startDate, c.days = e.Days ? e.Days : c.days, c.cellDuration = e.CellDuration ? e.CellDuration : c.cellDuration, c.cellGroupBy = e.CellGroupBy ? e.CellGroupBy : c.cellGroupBy, c.cellWidth = e.CellWidth ? e.CellWidth : c.cellWidth, "undefined" != typeof e.Scale && (c.scale = e.Scale), c.viewType = e.ViewType ? e.ViewType : c.viewType, c.hourNameBackColor = e.HourNameBackColor ? e.HourNameBackColor : c.hourNameBackColor, "undefined" != typeof e.ShowNonBusiness && (c.showNonBusiness = e.ShowNonBusiness), c.businessBeginsHour = e.BusinessBeginsHour ? e.BusinessBeginsHour : c.businessBeginsHour, c.businessEndsHour = e.BusinessEndsHour ? e.BusinessEndsHour : c.businessEndsHour, "undefined" != typeof e.DynamicLoading && (c.dynamicLoading = e.DynamicLoading), "undefined" != typeof e.TreeEnabled && (c.treeEnabled = e.TreeEnabled), c.backColor = e.BackColor ? e.BackColor : c.backColor, c.nonBusinessBackColor = e.NonBusinessBackColor ? e.NonBusinessBackColor : c.nonBusinessBackColor, c.locale = e.Locale ? e.Locale : c.locale, "undefined" != typeof e.TimeZone && (c.timeZone = e.TimeZone), c.timeFormat = e.TimeFormat ? e.TimeFormat : c.timeFormat, c.rowHeaderCols = e.RowHeaderCols ? e.RowHeaderCols : c.rowHeaderCols, "undefined" != typeof e.DurationBarMode && (c.durationBarMode = e.DurationBarMode), c.cornerBackColor = e.CornerBackColor ? e.CornerBackColor : c.cornerBackColor, "undefined" != typeof e.CornerHTML && (c.cornerHtml = e.CornerHTML), c.hashes = e.Hashes, c._f(), c.ag(), c.bg(), c.ca()), "Scroll" !== e.Action && c.da(e.Events), "Full" === e.UpdateType && (c.cg(), c.dg()), c.eg(), c.pa(), c.fg(), c.t.drawArea = null, "Scroll" !== e.Action ? (c.gg(), c.ea(), "Auto" !== c.heightSpec && "Max" !== c.heightSpec || c.la(), c.hg(), c.O(), c.ig(), c.multiselect.clear(!0), c.multiselect.jg(e.SelectedEvents), c.kg(), c.lg(), c.qa()) : (c.multiselect.clear(!0), c.multiselect.jg(e.SelectedEvents), c.mg(e.Events)), "HoldForever" !== c.timeRangeSelectedHandling && c.ng(), "Full" === e.UpdateType && (c.setScroll(e.ScrollX, e.ScrollY), c.Cf()), c.og(), c.Ya(), e.SelectedRows && c.pg(e.SelectedRows), c.Z(), "Full" === e.UpdateType && navigator.appVersion.indexOf("MSIE 7.") !== -1 && window.setTimeout(function() {
      c.cg(), c.la()
     }, 0), c.ta(), e.Message && c.message && c.message(e.Message), c._(e.CallBackData, !0), c.Zf(), c.$f(), "Full" !== e.UpdateType || "Scroll" === e.Action || c.onScrollCalled || setTimeout(function() {
      c.qg()
     }, 0)
    }, this.Ya = function() {
     ...
     c.rg.enabled ? (c.rg.scrollToRequested = e, setTimeout(function() {
      var e = c.rg.scrollToRequested;
      e && c.sg(e, t, i)
     }, 0)) : c.sg(e, t, i)
    }, this.sg = function(e, t, i) {
     if (e) {
      if ("Days" === c.viewType) {
       var n = c.tg(new DayPilot.Date(e));
       if (!n) return;
      ...
      if (a < 0 && (a = 0), a > o - r && (a = o - r), !t) return void c.vg(a);
      ...
      s > .6 && (d = Math.min(d, 80)), this.wg(a, d)
     }
     ...
     if (this.floatingTimeHeaders && this.timeHeader) {
      ...
      if (e) {
       ...
       for (var c = 0; c < n.length; c++) {
        var d = n[c];
        this.Bg(d.div, d.marginLeft, d.marginRight)
       }
      }
     }
    }, this.og = function() {
    ...
    h.eventsInRectangle = function(e, t, i, n) {
    ...
    }, this.elements.sections = [], this.elements.hsections = [], this.Bg = function(e, t, i) {
     var n = document.createElement("div");
    ...
    }, this.Hg = null, this.Gg = function(e) {
     return null === c.Hg && (c.Hg = parseInt(new DayPilot.StyleReader(e).get("padding-left"))), c.Hg
    }, this.Eg = function() {
     ...
     c.rg.enabled ? (c.rg.scrollXRequested = e, setTimeout(function() {
      var e = c.rg.scrollXRequested;
      "number" == typeof e && c.vg(e)
     }, 0)) : c.vg(e)
    }, this.vg = function(e) {
     var t = c.nav.scroll,
      i = c.Ig();
     ...
     c.rg.enabled ? (c.rg.scrollYRequested = e, setTimeout(function() {
      var e = c.rg.scrollYRequested;
      "number" == typeof e && c.Jg(e)
     }, 0)) : c.Jg(e)
    }, this.Jg = function(e) {
     var t = c.nav.scroll,
      i = c.Yf;
     ...
     c.Ga()
    }, this.Ng = null, this.la = function() {
     if (this.nav.scroll) {
      ! function() {
       var e = c.Ig();
       c.ug.style.height = c.Yf + "px", c.ug.style.width = e + "px", "Auto" !== c.cellWidthSpec || c.Og ? e > c.nav.scroll.clientWidth ? c.nav.scroll.style.overflowX = "auto" : c.nav.scroll.style.overflowX = "hidden" : (c.nav.scroll.style.overflowX = "hidden", c.nav.scroll.scrollLeft = 0)
      }();
      var e = 1;
      null !== this.Ng && (this.nav.top.style.border = this.Ng, this.Ng = null), "Parent100Pct" !== this.heightSpec && "Max100Pct" !== this.heightSpec || (this.nav.top.style.height = "100%", this.hideBorderFor100PctHeight && (this.Ng = this.nav.top.style.border, this.nav.top.style.border = "0 none"), this.height = parseInt(this.nav.top.clientHeight, 10) - this.Kg() - e), this.nav.scroll.style.height = "30px";
      var t = this.cc(),
       i = t + this.Kg() + e;
      t >= 0 && (this.nav.scroll.style.height = t + "px", this.Pg.style.height = t + "px"), this.nav.divider && ((!i || isNaN(i) || i < 0) && (i = 0), this.nav.divider.style.height = i + "px"),
       "Parent100Pct" !== this.heightSpec && (this.nav.top.style.height = i + "px"), c.nav.resScrollSpace && (c.nav.resScrollSpace.style.height = t + 20 + "px");
      for (var n = 0; n < this.elements.separators.length; n++) this.elements.separators[n].style.height = this.Yf + "px";
      for (var n = 0; n < this.elements.linesVertical.length; n++) this.elements.linesVertical[n].style.height = this.Yf + "px";
      c.Qg()
     }
    }, this.ag = function() {
     ...
     if (function() {
       if (e) {
        var t = 0;
        c.r() && c.timeline ? t = c.timeline.length : "Manual" === c.scale ? t = c.timeline.length : (c.Rg(), t = c.itline.length, c.itline = DayPilot.list());
        var i = c.Sg();
        if (t > 0 && i > 0) {
         var n = i / t;
         c.cellWidth = Math.max(n, c.cellWidthMin), c.Og = n < c.cellWidthMin
        }
       }
    ...
    u.shiftX = 0, u.active = !1, u.updateRowStarts = function() {
     DayPilot.list(c.rowlist).each(function(e, t) {
      e.start = c.Da(), e.data = null, c.Wg(t)
     })
     ...
     e > 0 && (i = -c.getPixels(a).left), c.startDate = c.startDate.addDays(e), c.itline = DayPilot.list(), c.t.pixels = [], c.Rg(), u.updateRowStarts(), e < 0 && (i = c.getPixels(n).left), c.timeHeader = [], c.Ug(), c.dg(), c.cellProperties = {}, c.hg(), c.ig(), c.da(), c.O(), c.la(), "undefined" != typeof t ? (c.scrollTo(new DayPilot.Date(t)), c.qg()) : c.nav.scroll.scrollLeft += i, c.lg(), c.qa(), u.active = !1
    }, this.Rg = function() {
     for (var e = "Days" !== this.viewType ? this.startDate.addDays(this.days) : this.startDate.addDays(1), t = this.startDate, i = this.Xg(t), n = !1, a = 0; i.ticks <= e.ticks && i.ticks > t.ticks;) {
      if (this.Yg(t, i, !0)) {
     ...
     if (e || (e = [{
      ...
      for (var i = c.Zg(), t = 0; t < e.length; t++) {
       var n = e[t].groupBy,
        a = e[t].format;
       "Default" === n && (n = this.cellGroupBy);
       for (var o = [], r = this.Da(); r.ticks < i.ticks;) {
        var l = {};
        if (l.start = r, l.end = this.$g(l.start, n), l.start.ticks === l.end.ticks) break;
        l.left = this.getPixels(l.start).left;
        var s = this.getPixels(l.end).left,
         d = s - l.left;
        if (l.width = d, l.colspan = Math.ceil(d / (1 * this.cellWidth)), "string" == typeof a ? l.innerHTML = l.start.toString(a, _.locale()) : l.innerHTML = this._g(l, n), l.text = l.innerHTML, d > 0) {
     ...
     for (var o = this.ah(e), r = Math.max(o.i - 1, 0), l = r; l < this.itline.length; l++) {
      var s = this.itline[l],
       d = s.start.ticks,
       c = s.end.ticks;
      if (d < t && t < c) {
       var h = t - d,
        a = {};
       a.cut = !1, a.left = s.left + this.pd(s, h), a.boxLeft = s.left, a.boxRight = s.left + s.width, a.i = l;
       break
      }
      if (d === t) {
       var a = {};
     ...
     return t ? r.addTime(this.ch(n.cell, n.offset)) : r
     ...
     if (e && !!e.preventDefault) {
      ...
      }), c.gh(r), r.e = r.old, delete r.old, r.multimove.each(function(e) {
       e.event = e.old, delete e.old
      })
     } else {
      e = new DayPilot.Event(e.copy(), c);
      var l = c.events.ih(e.data);
      e.start(t), e.end(i), e.resource(n), e.commit(), l = l.concat(c.events.jh(e.data)), c.kh(l), c.lh(), c.mh(l)
     }
     this.Za("Notify", e, t, i, n, a, o)
    }, this.eventResizeNotify = function(e, t, i, n) {
     var a = new DayPilot.Event(e.copy(), this),
      o = c.events.ih(e.data);
     e.start(t), e.end(i), e.commit(), o = o.concat(c.events.jh(e.data)), c.kh(o), c.lh(), c.mh(o), this.Va("Notify", a, t, i, n)
    }, this.multiselect = {}, this.multiselect.list = [], this.multiselect.divs = [], this.multiselect.previous = [], this.multiselect.jg = function(e) {
     ...
     var i = c.multiselect;
     i.indexOf(e) === -1 && i.list.push(e), t || i.nh(e)
    }, this.multiselect.remove = function(e, t) {
     var i = c.multiselect,
      n = i.indexOf(e);
     n !== -1 && i.list.splice(n, 1), t || i.nh(e)
    }, this.multiselect.clear = function(e) {
     var t = c.multiselect;
     t.list = [], e || t.redraw()
    }, this.multiselect.redraw = function() {
    ...
    }, this.multiselect.nh = function(e) {
     var t = c.multiselect,
      i = c.jd(e);
     t.ld(i)
    }, this.multiselect.Hb = function(e) {
     ...
     c.cg(), c.gg(), c.qh(), c.progressiveRowRendering && c.rh()
    }, this.ld = function(e) {
     var e = e || {},
      t = !e.eventsOnly;
     c.cssOnly || (c.cssOnly = !0, DayPilot.Util.log("DayPilot: cssOnly = false mode is not supported since DayPilot Pro 8.0.")), t && (this.r() || (c.timeHeader = null, c.cellProperties = {}), c.uh = {}, c._f(), c.ag(), e && e.dontLoadResources || c.bg(), c.events.vh(), c.zc.clearCache()), this.da(), this.wh(), c.cg(), t && (c.nd(), c.xh(), c.dg(), c.pg(c.selectedRows), c.yh()), c.eg(), c.gg(), c.qh(), c.ea(), v.hideLinkpoints(), this.O(), this.hg(), this.$f(), this.ca(), this.kg(), this.oh(), c.la(), e.immediateEvents || e.eventsOnly ? c.qa() : setTimeout(function() {
      c.qa()
     }, 100), this.visible ? c.Vf != c.visible && this.show() : this.hide(), this.Vf = this.visible, this.og(), (c.kd.scope || c.rg.enabled) && !c.A || this.qg(), this.zh(), this.ta()
    }, this.zh = function() {
    ...
    f.timeout = null, f.options = null, f.enabled = !1, f.request = function(e) {
     ...
     return f.options = null, c.A ? DayPilot.Util.isOnlyProperty(e, "events") ? (c.events.list = e.events, void c.ld({
      "eventsOnly": !0
     })) : DayPilot.Util.isOnlyProperty(e, "separators") ? (c.separators = e.separators, void c.oh()) : DayPilot.Util.isOnlyProperty(e, "rowHeaderColumns") ? (c.rowHeaderColumns = e.rowHeaderColumns, void c.ph()) : (c.od(e), c.ld({
      "immediateEvents": !0
     }), void c._(null, !1)) : void c.od(e)
     ...
     if (this.Bh) {
      this.eg(), this.gg(), this.hg(), this.ig();
      for (var n = 0; n < e.length; n++) {
       var a = e[n];
       this.Ch(a)
      }
      ...
      this.kg(), this.lg(), this.Eh()
     } else {
      for (var n = 0; n < e.length; n++) {
       var a = e[n];
       t || this.Ch(a), this.Dh(a)
      }
      DayPilot.list(e).each(function(e) {
       c.Fh(e)
      }), c.kg()
     }
     c.Cg(), v.load(), c.multiselect.redraw(), i && i(), this.$f()
    }, this.lf = function(e) {
     ...
     if (c.Lc = null, "Disabled" !== c.eventMoveHandling) {
      ...
      if (s.event = e, s.start = t, s.end = i, s.overlapping = !1, s.resource = n, l.multimove.splice(0, 0, s), l.position = r, l.preventDefault = function() {
       ...
       var d = function() {
        if (C.hide(), l.preventDefault.value) return void c.Gh();
        ...
        c.Gh(), "function" == typeof c.onEventMoved && c.onEventMoved(l)
       };
     ...
     if ("Disabled" !== c.timeRangeSelectedHandling) {
      ...
      if (a.control = c, a.start = e, a.end = t, a.resource = i, a.preventDefault = function() {
       ...
       switch (c.Jh(c.rangeHold, e, t, a.multirange), c.Kh(c.rangeHold), c.timeRangeSelectedHandling) {
        case "PostBack":
         c.hh("PostBack", a);
         break;
        case "CallBack":
    ...
    }, this.Jh = function(e, t, i, n) {
     if (e && !(n && n.length > 1)) {
      var a, o, r = c.Me(i),
       l = 0;
      if ("Days" === c.viewType) {
       l = c.tg(t).start.getTime() - c.Da().getTime()
      }
      t.getTime() < c.itline[0].start.getTime() ? e.start.x = 0 : (a = c.dh(t.addTime(-l)), o = a.current || a.previous, e.start.x = DayPilot.indexOf(c.itline, o)), a = c.dh(r.addSeconds(-1).addTime(-l)), a.past ? e.end.x = c.itline.length - 1 : (o = a.current || a.next, e.end.x = DayPilot.indexOf(c.itline, o))
     }
    }, this.tg = function(e) {
     var t = e.getDatePart();
    ...
    }, this.resourceHeaderMenuClickCallBack = this.rowMenuClickCallBack, this.Mh = function(e, t, i) {
     switch (i) {
      case "PostBack":
     ...
     if (e.isNewRow) return void(i || c.Ph(e, t));
    ...
    }, this.resourceHeaderClickCallBack = this.rowClickCallBack, this.Rh = function(e, t, i, n) {
     if ("Disabled" === c.rowDoubleClickHandling) return void c.Sh(e, t, i, n);
     ...
     this.Yh("CallBack", e, t)
    }, this.commandPostBack = function(e, t) {
     this.Yh("PostBack", e, t)
     ...
     o = "undefined" != typeof Iuppiter && Iuppiter.compress ? "LZJB" + Iuppiter.Base64.encode(Iuppiter.compress(r)) : "JSON" + r, this.Zh(a), this.backendUrl ? DayPilot.request(this.backendUrl, this.J, o, this.K) : "function" == typeof WebForm_DoCallback && WebForm_DoCallback(this.uniqueID, o, this.L, null, this.callbackError, !0)
    }, this.Zh = function(e) {
     var t = {};
     ...
     var i = {};
     i.start = {}, i.end = {}, i.start.x = Math.floor(e / c.cellWidth), i.end.x = Math.floor((e + c.nav.scroll.clientWidth) / c.cellWidth), i.start.y = c.fi(t).i, i.end.y = c.fi(t + c.nav.scroll.clientHeight).i, i.start.x = Math.max(i.start.x, 0);
     ...
     if (!e) var e = this._h(this.nav.scroll.scrollLeft, this.nav.scroll.scrollTop);
     var t = [];
     t.ignoreToJSON = !0;
     ...
     var e = c;
     if (e.hi && !e.Kd) {
      e.Kd = !0, e.N(), clearInterval(e.Xc), clearInterval(e.ii);
    ...
    this.mi = v, v.clear = function() {
     ...
     if ("function" == typeof e) return c.ri(e);
     ...
     var t = c.jd(e);
     return t || DayPilot.list(c.events.si.rows).isEmpty() ? void c.Ka(t) : void setTimeout(function() {
      c.Ka(c.jd(e))
     })
    }, this.events.load = function(e, t, i) {
     if (!e) throw new DayPilot.Exception("events.load(): 'url' parameter required");
     ...
     for (var t = 0; t < c.rowlist.length; t++) {
      ...
      if (!i.isNewRow) {
       ...
       for (var n = 0; n < i.events.length; n++) {
        var a = i.events[n];
        if (c.ui(a.data, e)) return i.events[n]
       }
      }
     }
     return null
     ...
     if (DayPilot.list(c.events.list).find(function(t) {
       return c.ui(t, e.data)
      })) {
      if (c.kd.scope) c.kd.notify(function() {
       e.commit()
      });
      else if (c.rg.skip = !0, (c.eventUpdateInplaceOptimization || i.inplace) && n.oldEvent.resource() === n.newEvent.resource() && n.oldEvent.start() === n.newEvent.start() && n.oldEvent.end() === n.newEvent.end()) {
       e.commit();
       var r = c.jd(e);
       if (r) {
        var l = r.event.part;
        c.yi(r), DayPilot.rfa(c.elements.events, r), e.part = l
       } else a("Old div not found");
       c.events.ih(e.data);
       var s = c.events.jh(e.data);
       c.kh(s);
       var d = c.events.vi(e.data);
       d && c.Ub(d)
      } else {
       var s = c.events.ih(e.data);
       e.commit(), s = s.concat(c.events.jh(e.data)), c.events.zi(s)
      }
      return o
     }
    }, this.events.remove = function(e, t) {
     ...
     if (a >= 0 && c.events.list.splice(a, 1), c.kd.scope) c.kd.notify();
      ...
      c.rg.skip = !0;
      var o = c.events.ih(e.data);
      if (c.eventUpdateInplaceOptimization && 1 === o.length && !c.events.Ai(e)) {
       c.Bi(c.rowlist[o[0]]);
       var r = c.jd(e);
       if (r) {
        var a = c.elements.events.indexOf(r);
        c.elements.events.splice(a, 1), c.yi(r)
       }
      } else c.events.zi(o)
     }
     return n
     ...
     if (c.kd.scope) c.kd.notify();
      ...
      var n = {};
      n.e = e;
      var a = c.events.jh(e.data),
       o = e.data.height || c.eventHeight;
      if (c.eventUpdateInplaceOptimization && 1 === a.length && !c.events.Ai(e) && o <= c.eventHeight && !c.eventVersionsEnabled) {
       var r = c.rowlist[a[0]];
       c.Bi(r);
     ...
     "rows": []
    }, this.events.Ci = null, this.events.vh = function() {
     clearTimeout(c.events.Ci), c.events.si.rows = []
    }, this.events.queueUpdateInterval = 0, this.events.zi = function(e) {
     var t = c.events.si.rows;
     DayPilot.list(e).each(function(e) {
      t.push(e)
     }), c.events.si.rows = DayPilot.ua(t);
     var i = c.events.immediateRefresh;
     c.events.Ci || (c.events.Ci = setTimeout(i, c.events.queueUpdateInterval))
    }, this.events.immediateRefresh = function() {
     clearTimeout(c.events.Ci), c.events.Ci = null;
     var e = c.events.si.rows;
     c.events.si.rows = [], c.kh(e), c.lh(), c.A && ("Gantt" === c.viewType ? c.update() : (c.mh(e), c.la(), c.Di()))
    }, this.rg = {}, this.rg.enabled = !1, this.rg.skip = !1, this.rg.skipUpdate = function() {
     return c.rg.skip
    }, this.rg.skipped = function() {
     c.rg.skip = !1
    }, this.queue = {}, this.queue.list = [], this.queue.list.ignoreToJSON = !0, this.queue.add = function(e) {
     if (e) {
      if (!e.isAction) throw "DayPilot.Action object required for queue.add()";
     ...
     var i = c.fh(e),
      ...
      r = i.end.addTime(a),
      l = {};
     l.x = e, l.y = t, l.i = e + "_" + t, !n.id, l.resource = n.id, l.start = o, l.end = r, l.calendar = c, l.isParent = n.children && n.children.length, l.update = function() {
     ...
     if (DayPilot.isArray(e)) {
      for (var i = [], n = 0; n < e.length; n++) {
       var a = e[n];
       i.push(c.cells.Ei(a.x, a.y))
      }
      return g(i)
     }
     return null === e || null === t ? g() : g(c.cells.Ei(e, t))
    };
    var p = function(e) {
     var t = DayPilot.list();
     if (DayPilot.isArray(e))
    ...
    this.kd = {}, this.kd.scope = null, this.kd.notify = function(e) {
    ...
    }, this.debug = new DayPilot.Debug(this), this.Ii = function(e) {
     ...
     if (f && !e.part.external && (u = this.rowlist[e.part.dayIndex].start.getTime() - this.Da().getTime()), a && !o) {
      var v = c.dh(e.start()),
       p = !v.hidden && !v.past;
      l = e.start().getTime() - this.Ji(e.start().addTime(-u)).addTime(u).getTime(), p && (l = function(e, t) {
       var i = c.Li(c.dh(e).current),
        n = c.Li(c.bh(s).cell);
       if (i > 1.2 * n) {
     ...
     n.resizing && (D = e.start()), this.snapToGrid && (D = this.Ji(D.addTime(-u)).addTime(u)), D = D.addTime(l);
     var k = D.addTime(i),
      x = D,
      P = k;
     if (f) {
     ...
     if (n.moveDragStart && c.eventMoveSkipNonBusiness) {
      ...
      this.snapToGrid && (A = this.Ji(A.addTime(-u)).addTime(u));
      var T = !e.part.dayIndex,
       E = 0;
      T || (E = c.Ni(e.start(), A, e.part.dayIndex));
      var i = c.Oi(e),
       M = c.getDate(s, !0);
      c.snapToGrid && (M = c.getDate(s));
      var h = c.Pi(M, E, S);
      D = M.addTime(-h).addTime(u), this.snapToGrid && (D = this.Ji(D.addTime(-u)).addTime(u)), l = T ? 0 : c.Ni(this.Ji(e.start().addTime(-u)).addTime(u), e.start(), S), D = D.addTime(l), k = c.Qi(D, i, S), k >= c.visibleEnd() && (k = c.visibleEnd(), D = k.addTime(-c.Ri(k, i))), x = D.addTime(-u), P = k.addTime(-u)
     }
    ...
    }, this.Ni = function(e, t, i) {
     var n = c.rowlist[i],
      a = n.data.start.getTime() - c.Da().getTime(),
      o = (c.dh(e), e.addTime(-a)),
      r = t.addTime(-a),
      l = c.Ti(o, i);
     if (!l) throw new DayPilot.Exception("No next cell found");
     var s = 0,
     ...
     var t = e.part.dayIndex;
     return c.Ni(e.start(), e.rawend(), t)
    }, this.Ri = function(e, t) {
     var i = 0,
      n = t,
      a = c.dh(e);
     ...
     return new DayPilot.Export(i)
    }, this["export"] = this.exportAs, this.sd = {};
    var m = this.sd;
    m.getWidth = function() {
     var e = m.ud;
     switch (e) {
      ...
      case "full":
       return c.Ig() + m.getRowHeaderWidth();
      case "range":
     ...
     switch (e) {
      ...
      case "full":
       return c._i() + c.Kg() - DayPilot.sh(c.nav.scroll);
      case "range":
       var t = m.getRows();
       if (0 === t.length) return c.Kg();
       var i = t.first(),
        n = t.last();
       return n.top - i.top + n.height + c.Kg();
      default:
       throw "Unsupported export mode: " + e
     }
    }, m.getRangeStart = function() {
     var e = m.td.dateFrom || c.Da();
     return new DayPilot.Date(e)
    }, m.getRangeEnd = function() {
     var e = m.td.dateTo || c.Zg();
     return new DayPilot.Date(e)
    }, m.getRangeResStart = function() {
     return m.td.resourceFrom ? c.xg(m.td.resourceFrom) : c.rowlist.find(function(e) {
      return !e.hidden
     })
    }, m.getRangeResEnd = function() {
     return m.td.resourceTo ? c.xg(m.td.resourceTo) : c.rowlist.last()
     ...
     switch (a) {
      case "viewport":
       e = c.aj, t = e + c.nav.scroll.offsetHeight, i = c.fi(e).i, n = c.fi(t).i;
       break;
      case "full":
     ...
     if (c.itline && c.itline.length > 0) {
      var t = c.dh(m.getRangeStart()).i,
       i = c.dh(m.getRangeEnd()).i,
       n = c.bj();
     ...
     if ("full" === m.ud) return DayPilot.list(c.timeHeader[e]);
    ...
    }, m.td = null, m.ud = null, m.generate = function(e, t) {
     "object" == typeof e && (t = e, e = null);
     var t = t || {},
      e = e || t.format || "svg",
      i = t.scale || 1;
     ...
     if ("config" !== e) {
      "jpg" === e.toLowerCase() && (e = "jpeg");
      var n = t.area || "viewport";
      m.td = t, m.ud = n, m.getRows().each(function(e) {
       c.fj(e)
      });
      var a, o = m.getWidth(),
       r = m.getHeight();
      ...
      if (DayPilot.de(N), c.rowHeaderColumns && c.ji && c.ji.blocks[0]) var O = c.ji.blocks[0].section.firstChild,
      ...
      DayPilot.list(c.rowHeaderColumns).each(function(e, t) {
       var i = c.rowHeaderCols[t],
        n = {};
       n.x = q, n.w = i + 1, n.y = l.corner.h - c.ji.height, n.h = c.ji.height + 1;
       var o = 3,
      ...
      var Y = "function" == typeof c.onBeforeCellExport;
      m.getRows().each(function(e, t, i) {
       ...
       m.getTimeline().each(function(i, n, o) {
        var n = o.offset + n,
         ...
         f = r.backColor || (s ? C : P);
        Y && (d || (d = {}, d.cell = c.cells.findXy(n, t)[0]), d.text = h, d.horizontalAlignment = u, d.backColor = f, c.onBeforeCellExport(d), h = d.text, u = d.horizontalAlignment, f = d.backColor);
      ...
      return m.getRows().each(function(e) {
       ...
       var h = {};
       h.text = d.html, h.backColor = d.backColor || L, h.fontSize = U.size, h.fontFamily = U.family, h.fontStyle = U.style, h.fontColor = z, h.borderColor = u, h.horizontalAlignment = "left", e.isNewRow && (h.text = c.rowCreateHtml), V && (h.row = c.Oh(e), c.onBeforeRowHeaderExport(h));
       var f = {
         "x": o,
     ...
     if (n.resizing) {
      ...
      if (b.list = [], b.forbidden = !1, b.invalid = !1, b.rowoffset = o, b.additional().each(function(e) {
        if (e.event) {
         ...
         var w = document.createElement("div");
         w.className = c.q("_shadow_inner"), y.appendChild(w), c.ug.appendChild(y), b.divs.push(y)
        }
       }), b.invalid) {
      ...
      DayPilot.list(b.divs).each(function(e) {
       if (e.info) {
        ...
        c.kj(t, r, d, h, u), t.overlapping && (i.overlapping = !0, b.forbidden = !0)
       }
      })
     }
    }, this.lj = {}, this.lj.modifiedProps = function() {
    ...
    w.divs = [], w.list = [], w.forbidden = !1, w.verticalAll = function() {
     ...
     if (n.moving) {
      ...
      if (w.verticalAll() || (r = 0), w.list = [], w.forbidden = !1, w.invalid = !1, w.rowoffset = r, w.additional().each(function(e) {
        if (e.event) {
         ...
         var y = document.createElement("div");
         y.className = c.q("_shadow_inner"), m.appendChild(y), c.ug.appendChild(m), w.divs.push(m)
        }
       }), w.invalid) {
      ...
      DayPilot.list(w.divs).each(function(e) {
       if (e.info) {
        ...
        c.kj(t, o, d, h, u), t.overlapping && (i.overlapping = !0, w.forbidden = !0)
       }
      })
     }
    }, w.clear = function() {
     ...
     if ("right" === t) {
      ...
      var e = n.resizing.event,
       ...
       i = o,
       a = r;
      c.kj(n.resizingShadow, t, i, a, e.data)
     }(), c.oj()
    }, this.Zi = function() {
     this.nav.scroll;
       ...
       l ? (e.style.left = t.left + "px", c.eventMoveToPosition ? e.style.width = c.cellWidth + "px" : e.style.width = t.width + "px", e.start = t.start, e.end = t.end) : (e.style.left = i.part.left + "px", e.start = i.start(), e.end = i.rawend(), t.left = i.part.left),
        ...
        function() {
         ...
         if (!t || t.start.getTime() !== e.start.getTime() || t.end.getTime() !== e.end.getTime() || t.resource !== e.row.id) {
          ...
          l.html ? e.firstChild.innerHTML = l.html : e.firstChild.innerHTML = "", c.pj(e, l), c.qj(n.movingShadow, l), l.link && (DayPilot.Global.movingLink && DayPilot.Global.movingLink.clear(), DayPilot.Global.movingLink = v.drawLink(l.link.from, e, l.link))
         }
        }()
      }
     }
    }, this.kj = function(e, t, i, n, a) {
     ...
     if (this.rj(), e.calendar === c) {
      var i = {};
      i.left = parseInt(e.style.left), i.top = parseInt(e.style.top), i.right = i.left + parseInt(e.style.width);
      var n = t.left.width || 10,
       a = document.createElement("div");
      if (a.style.position = "absolute", a.style.left = i.left - n - t.left.space + "px", a.style.top = i.top + "px", a.style.height = c.eventHeight + "px", a.style.overflow = "hidden", a.style.boxSizing = "border-box", a.innerHTML = t.left.html, a.className = this.q("_event_move_left"), a.onmousemove = c.sj, t.left.enabled)
       if (c.divHover.appendChild(a), t.left.width) a.style.width = n + "px";
        ...
        var s = c.tj() + (r - l);
        s > 0 && (a.style.left = s + "px", a.style.top = i.top - c.nav.scroll.scrollTop + c.Kg() + "px", c.nav.top.appendChild(a), c.elements.hover.push(a))
       }
      var n = t.right.width || 10,
       d = document.createElement("div");
      if (d.style.position = "absolute", d.style.left = i.right + t.right.space + "px", d.style.top = i.top + "px", d.style.height = c.eventHeight + "px", d.style.overflow = "hidden", d.style.boxSizing = "border-box", t.right.width ? d.style.width = t.right.width + "px" : d.style.whiteSpace = "nowrap", d.innerHTML = t.right.html, d.className = this.q("_event_move_right"), d.onmousemove = c.sj, t.right.enabled) {
     ...
     if (this.Vc()) {
      ...
      if (this.rowHeaderWidthAutoFit) {
       ...
       if (!i) return;
       if (!i.rows) return;
       for (var n = [], a = c.vj(), o = a.start; o < a.end; o++) {
        var r = i.rows[o];
      ...
      e && (this.ji && (this.ji.widths = this.rowHeaderCols, this.ji.updateWidths(), DayPilot.Util.updatePropsFromArray(this.rowHeaderColumns, "width", this.rowHeaderCols)), this.rowHeaderScrolling || (this.rowHeaderWidth = t), this.qh(), this.yj())
     }
    }, this.cg = function() {
     this.zj = !0, this.uj();
     var e = this.tj(),
     ...
     if (t.style.width = e + "px", t.style.height = c.Yf + "px", t.rows = [], c.progressiveRowRendering) a();
     else
      for (var n = this.rowlist.length, i = 0; i < n; i++) c.Aj(i);
     c.Bj(), this.divResScroll.appendChild(t), this.rowHeaderWidthAutoFit && this.xj()
    }, this.rh = function() {
     if (c.progressiveRowRendering) {
      for (var e = this.vj(), t = 0; t < c.rowlist.length; t++) e.start <= t && t < e.end ? c.Aj(t) : c.Cj(t);
      if (this.rowHeaderWidthAutoFit) {
       var i = c.Lg();
       this.xj();
       if (c.Lg() !== i) {
        ...
        this._f();
        this.cellWidth !== n && (c.ag(), c.dg(), c.la(), c.da(), c.Dj())
       }
      }
     }
    }, this.Bj = function() {
     ...
     t.style.width = n + "px", t.style.top = this.Yf + "px", t.style.height = c.divResScroll.clientHeight + 20 + "px"
    }, this.Cj = function(e) {
       ...
       if (b.style.position = "absolute", b.style.bottom = "0px", b.style.width = "100%", b.style.height = "1px", b.className = this.q(E.resourcedivider), f.appendChild(b), function() {
         if (c.treeEnabled && !r.isNewRow) {
          ...
          n.style.width = "10px", n.style.height = "10px", n.style.backgroundRepeat = "no-repeat", n.style.position = "absolute", n.style.left = t + "px", n.style.top = c.treeImageMarginTop + "px", r.loaded || 0 !== r.children.length ? r.children.length > 0 ? (r.expanded ? n.className = c.q("_tree_image_collapse") : n.className = c.q("_tree_image_expand"), n.style.cursor = "pointer", n.index = e, n.onclick = function(e) {
           ...
           c.Kj(this.index), e = e || window.event, e.cancelBubble = !0
          }), v.appendChild(n)
         }
         var a = document.createElement("div");
        ...
        for (var w = u, D = 1; D < a; D++) {
         var k = h.columns[D - 1] || {},
          d = document.createElement("div");
         d.style.position = "absolute", d.style.top = r.top + "px", d.style.left = w + "px", t.appendChild(d), i.rows[e].cells.push(d), d.row = r, d.index = e, h.toolTip && (d.title = h.toolTip), d.setAttribute("unselectable", "on"), d.onmousemove = c.Ej, d.onmouseout = c.Fj, d.onmouseup = c.Gj, d.oncontextmenu = c.Hj, d.onclick = c.Ij, d.ondblclick = c.Jj;
         var f = document.createElement("div"),
          x = n[D];
         w += x;
         var P = k.backColor || h.backColor;
         P && (f.style.backgroundColor = P), f.style.width = x + "px", f.style.height = r.height + "px", f.style.overflow = "hidden", f.style.position = "relative", f.setAttribute("unselectable", "on"), DayPilot.Util.addClass(f, this.q("_rowheader")), DayPilot.Util.addClass(f, this.q("_rowheadercol")), DayPilot.Util.addClass(f, this.q("_rowheadercol" + D)), h.cssClass && DayPilot.Util.addClass(f, h.cssClass), k.cssClass && DayPilot.Util.addClass(f, k.cssClass), k.horizontalAlignment && (f.style.textAlign = k.horizontalAlignment);
         var v = document.createElement("div");
         v.setAttribute("unselectable", "on"), v.className = this.q("_rowheader_inner"), f.appendChild(v);
         var b = document.createElement("div");
     ...
     var e = this.row;
     return e.contextMenu && e.contextMenu.show(c.Oh(e)), !1
    }, this.Ij = function(e) {
     if (!x.cancelClick) {
      var t = this.row,
       i = c.Oh(t, this.index);
      return t.isNewRow ? void c.Uh.edit(t) : void c.Rh(i, e.ctrlKey, e.shiftKey, e.metaKey)
     }
    }, this.Jj = function(e) {
     ...
     if (c.va()) {
      ...
      switch (c.rowDoubleClickHandling) {
       ...
       case "CallBack":
        ...
        break;
       case "Select":
        c.Th(i, e.ctrlKey, e.shiftKey, e.metaKey);
        break;
       case "Edit":
        c.Uh.edit(i)
      }
     ...
     var t = {};
     t.start = this.cell.start, t.level = this.cell.level, t.end = this.cell.end, t.end || (t.end = new DayPilot.Date(t.start).addMinutes(c.cellDuration)), c.Vh(t)
    }, this.Oh = function(e) {
     ...
     if (t.events || t.resetEvents(), !t.data) {
      ...
      var i = this.Zg().getTime() - this.Da().getTime();
    ...
    D.rowCache = {}, D.prepareRows = function(e) {
     ...
     for (var t = 0; t < c.rowlist.length; t++) {
      var i = c.rowlist[t];
      if (e && i.resetEvents(), c.Wg(t), i.id) {
       var n = i.id.toString();
       D.rowcache[n] || (D.rowcache[n] = DayPilot.list()), D.rowcache[n].push(i)
      }
     }
    }, D.loadEvent = function(e) {}, this.wi = function() {
     var e = {};
      ...
      if (t)
       for (var n = 0; n < e.blocks.length; n++) {
        ...
        var d = DayPilot.list(l.events).map(function(e) {
         ...
         return DayPilot.contains(c.Nj, e)
        });
        d && (l.expanded = !0);
     ...
     if (!t.hideEvents) {
      ...
      d.part.start === d.part.end && (u = this.getPixels(d.part.end.addTime(-t.data.offset).addSeconds(1))), r && r.height ? d.part.height = r.height : e.height && (d.part.height = e.height), d.part.Oj = function() {
       var e = this.height;
      ...
      if (d.part.width = Math.max(d.part.width, w), c.eventVersionsEnabled && c.Pj(d, t), "function" == typeof c.onEventFilter && c.events.ed) {
       var D = {};
    ...
    k.get = function() {
     ...
     DayPilot.list(x.selected).some(function(t) {
      return t === e.$.row
     }) || x.selected.push(e.$.row), x.Rj(), k.Sj()
    }, k.remove = function(e) {
     if (!e || !e.isRow) throw "DayPilot.Scheduler.rows.selection.remove(): DayPilot.Row object expected";
     k.isSelected(e) && (x.unselect(e.$.row), DayPilot.rfa(x.selected, e.$.row)), k.Sj()
     ...
     c.Tj = !0, c.Uj(), c.yj(), c.Qg()
    }, this.rows.headerShow = function() {
     c.Tj = !1, c.Uj(), c.yj(), c.Qg()
    }, this.rows.headerToggle = function() {
     c.Tj ? c.rows.headerShow() : c.rows.headerHide()
     ...
     var t = e.index,
      ...
      o = c.Vj(n),
      e = c.Wj(o, a);
     e.hidden = i.hidden, e.level = i.level, e.children = i.children, e.index = t, e.top = i.top, e.height = i.height, c.rowlist[t] = e, e.resetEvents(), c.Wg(t), c.Xj(e), c.Bi(e), c.Ah(t), c.hg(), c.kg()
    }, this.Xj = function(e) {
     ...
     if (x.resetMoving(), c.va()) {
      var a = {};
      if (a.source = c.Oh(e), a.source.calendar = n, a.target = c.Oh(t), a.position = i, a.preventDefault = function() {
        this.preventDefault.value = !0
     ...
     x.selected = [], t.isEmpty() || (c.Sf = !1, c.ca()), t.each(function(e) {
      var t = c.xg(e);
      t && x.selected.push(t)
     }), x.Rj()
    }, this.Uh = {};
    ...
    x.edit = function(e) {
     ...
     x.Qj || x.rowSelectLastSetDefault();
     var e = DayPilot.indexOf(c.rowlist, x.Qj.row);
     if (!(e > -1)) {
      var t = c.xg(x.Qj.row.id);
      t ? (e = DayPilot.indexOf(c.rowlist, t), x.Qj = {
       "row": t,
       "index": e
     ...
     return o.focus(), o.onblur = function() {
      o.onblur = null;
      var t = o.value;
      l(), DayPilot.Areas.enable(i.firstChild), c.Qh(e, t, o.canceled)
    ...
    }, x.Qj = null, x.clearSelection = function() {
     for (var e = 0; e < x.selected.length; e++) {
      var t = x.selected[e];
      x.unselect(t)
     }
     ...
     var t = e.source.$.row.resource,
      ...
      n = e.position;
     if ("forbidden" !== n) {
      var a = e.source.calendar.ak.findParentArray(t);
    ...
    var P = {};
    this.ak = P, P.findParentArray = function(e) {
     ...
     var e = this.resources,
      t = this.r();
     t || ("Gantt" === this.viewType ? e = this.bk() : "Days" === this.viewType && (e = this.ck())), !t || "Days" !== this.viewType || e && 0 !== e.length || (e = this.ck());
     var i = {};
     if (i.i = 0, null != e && !DayPilot.isArray(e)) throw "DayPilot.Scheduler.resources expects an array object";
     this.dk(e, i, 0, null, this.treeEnabled, !1), "Disabled" !== c.rowCreateHandling && this.ek()
    }, this.ek = function() {
     var e = {};
    ...
    this.visibleStart = function() {
     ...
     if (i.backColor = e.backColor, i.cssClass = e.cssClass, i.expanded = e.expanded, i.name = e.name, i.html = e.html ? e.html : i.name, i.eventHeight = "undefined" != typeof e.eventHeight ? e.eventHeight : c.zc.eventHeight(), i.minHeight = "undefined" != typeof e.minHeight ? e.minHeight : c.rowMinHeight, i.marginBottom = "undefined" != typeof e.marginBottom ? e.marginBottom : c.rowMarginBottom, i.marginTop = "undefined" != typeof e.marginTop ? e.marginTop : c.rowMarginTop, i.eventStackingLineHeight = "undefined" != typeof e.eventStackingLineHeight ? e.eventStackingLineHeight : c.eventStackingLineHeight, i.loaded = !e.dynamicChildren, i.id = e.id || e.value, i.toolTip = e.toolTip, i.children = [], i.columns = [], i.start = e.start ? new DayPilot.Date(e.start) : this.Da(), i.isParent = e.isParent, i.contextMenu = e.contextMenu ? DayPilot.Util.evalVariable(e.contextMenu) : this.contextMenuResource, i.areas = e.areas, i.moveDisabled = e.moveDisabled, i.bubbleHtml = e.bubbleHtml, i.tags = e.tags, i.task = e.task, i.swimlane = e.swimlane, i.hideEvents = e.hideEvents, i.height = i.eventHeight, i.resource = e.gk, i.lines = [], i.blocks = [], i.isRow = !0, i.getHeight = function() {
      ...
      }, i.hk = !1, i.ik = t, i.jk = function() {
       this.hidden = !this.kk(), this.hk = !1, this.ik && this.ik.jk()
      }, i.kk = function() {
       return !this.ik || this.ik.kk() && this.ik.expanded
      }, e.columns)
     ...
     c.rowlist.each(function(e) {
      if ("function" == typeof c.onRowFilter && c.rows.ed) {
       var t = e.ik,
        i = {};
       i.visible = !0, i.row = c.Oh(e), i.filter = c.rows.ed, c.onRowFilter(i), e.hk = !i.visible, i.visible ? t && t.jk() : e.hidden = !0
      }
     })
    }, this.dk = function(e, t, i, n, a, o) {
     if (e)
       ...
       if (e[r]) {
        ...
        if (l.level = i, l.hidden = o, l.index = t.i, !e[r].hidden) {
         ...
         if (o && (d.hidden = !0), d.level = i, d.index = t.i, null !== n && n.children.push(t.i), this.rowlist.push(d), t.i++, a && s.children && s.children.length) {
          var h = o || !d.expanded;
          this.dk(s.children, t, i + 1, d, !0, h)
         }
        }
       }
    }, this.hj = function(e) {
     ...
     if ("DivBased" === this.zc.layout()) {
      ...
      var s = l.insertRow(-1);
      s.insertCell(-1).appendChild(this.Bc()), s.insertCell(-1).appendChild(this.pk());
      var d = l.insertRow(-1);
      d.insertCell(-1).appendChild(this.nk()), d.insertCell(-1).appendChild(this.qk()), this.nav.top.appendChild(l)
     }
     ...
     var h = document.createElement("div");
     h.style.position = "absolute", h.style.left = this.Lg() + _.splitterWidth() + 5 + "px", h.style.top = this.Kg() + 5 + "px", h.style.display = "none", h.innerHTML = this.loadingLabelText, DayPilot.Util.addClass(h, this.q("_loading")), this.nav.loading = h, this.nav.top.appendChild(h), this.rk()
    }, this.Mf = function(e) {
     if (l.row) {
      ...
      if (function() {
       ...
       if ("function" == typeof c.onRowMoving) {
        var g = {};
        g.source = c.Oh(l.source), g.target = c.Oh(l.target), g.position = u, c.onRowMoving(g), l.position = g.position
       }
      ...
      var m = DayPilot.mo3(c.nav.top, e).x,
       y = c.tj(),
       b = Math.min(y, m - 1);
      c.rowHeaderWidth = b, c.Tj = !1, c.Uj()
     }
    }, this.ea = function() {
     var e = this.Kg();
     ...
     if (this.Tj) return 0;
     var e = 0;
     return e = this.rowHeaderScrolling ? this.rowHeaderWidth : this.tj()
    }, this.ok = function() {
     ...
     if (this.nav.corner.style.width = t + "px", this.divCorner.style.width = t + "px", this.divResScroll.style.width = t + "px", "DivBased" === _.layout() && (this.nav.left.style.width = t + "px", this.nav.divider.style.left = t - e + "px", this.nav.right.style.marginLeft = t + "px"), this.nav.message && (this.nav.message.style.left = t + e + "px"), this.nav.loading && (this.nav.loading.style.left = t + e + 5 + "px"), this.nav.hideIcon) {
      ...
      i.style.left = t - 1 + "px", c.Tj ? (DayPilot.Util.removeClass(i, a), DayPilot.Util.addClass(i, n)) : (DayPilot.Util.removeClass(i, n), DayPilot.Util.addClass(i, a))
     }
    }, this.sk = function() {
     this.uj();
     var e = this.tj(),
      t = function(e, t, i) {
       if (e && e.style) {
        var n = e.firstChild;
        c.zj ? (e.style.width = t + "px", n.style.width = t + "px", "number" == typeof i && (e.style.left = i + "px")) : n.style.width = t + "px"
       }
      },
      i = this.divHeader;
     i.style.width = e + "px";
     for (var n = c.vj(), a = n.start; a < n.end; a++) {
      var o = i.rows[a];
      if (o) {
       var r = o.cells[0];
       if (r.colSpan > 1) {
     ...
     var a = document.createElement("div");
     a.style.position = "absolute", a.style.top = "0px", a.style.bottom = "0px", a.style.left = "0px", a.style.right = "0px", a.className = this.q("_columnheader_inner"), n.appendChild(a), c.ji && (c.ji.dispose(), c.ji = null);
     ...
     o.widths = DayPilot.Util.propArray(t, "width", c.rowHeaderColumnDefaultWidth), o.height = _.headerHeight(), o.css.title = this.q("_columnheader_cell"), o.css.titleInner = this.q("_columnheader_cell_inner"), o.css.splitter = this.q("_columnheader_splitter"), o.titles = DayPilot.Util.propArray(t, "title"), o.updating = function(e) {
      DayPilot.Util.updatePropsFromArray(c.rowHeaderColumns, "width", this.widths), c.qh(), "Auto" === c.cellWidthSpec
     ...
     }, o.color = "#000000", o.opacity = 30, o.init(), e.appendChild(i), this.ji = o
    }, this.xh = function() {
     ...
     if (t.style.position = "absolute", t.style.top = "0px", t.style.left = "0px", t.style.right = "0px", t.style.bottom = "0px", t.className = this.q("_corner_inner"), this.divCorner = t, t.innerHTML = "&nbsp;", this.rowHeaderColumns && this.rowHeaderColumns.length > 0) {
      ...
      var n = document.createElement("div");
      n.style.position = "absolute", n.style.left = "0px", n.style.right = "0px", n.style.height = "1px", n.style.bottom = _.headerHeight() + "px", n.className = this.q("_divider"), e.appendChild(n), i.appendChild(t), this.tk()
     ...
     var e = this.Lg(),
      t = document.createElement("div");
     return c.nav.corner = t, t.style.width = e + "px", t.style.height = this.Kg() + "px", t.style.overflow = "hidden", t.style.position = "relative", t.setAttribute("unselectable", "on"), t.onmousemove = function() {
      c.U()
    ...
    }, this.uk = null, this.vk = function() {
     return c.scrollStep || c.eventHeight
    }, this.nk = function() {
     var e = document.createElement("div");
     e.style.width = this.Lg() + "px", e.style.height = this.cc() + "px", e.style.overflow = "hidden", e.style.position = "relative", e.className = c.q("_rowheader_scroll");
     var t = c.vk(),
      i = navigator.userAgent.indexOf("Mobile") !== -1;
     return i && (e.style.overflowY = "auto"), e.onmousemove = function() {
      c.U()
     }, e.onscroll = function() {
      if (c.nav.columnScroll && c.rowHeaderScrolling && (c.nav.columnScroll.scrollLeft = e.scrollLeft), c.uk && clearTimeout(c.uk), i) {
       var t = c._i() - c.nav.scroll.offsetHeight;
       e.scrollTop = Math.min(e.scrollTop, t), c.nav.scroll.scrollTop = e.scrollTop
      } else c.uk = setTimeout(function() {
     ...
     }, e.setAttribute("role", "region"), e.setAttribute("aria-label", "scheduler rows"), this.divResScroll = e, this.Pg = e, e
    }, this.wk = function(e) {
     if ("TableBased" === _.layout()) {
      var t = parseInt(this.width, 10),
       i = isNaN(t) || this.width.indexOf("%") !== -1,
       n = (/MSIE/i.test(navigator.userAgent), this.tj());
      i ? this.nav.top && this.nav.top.offsetWidth > 0 && (e.style.width = this.nav.top.offsetWidth - 6 - n + "px") : e.style.width = t - n + "px"
     }
    }, this.ve = function(e) {
     c.fg(), c.qg()
    }, this.fg = function() {
     "TableBased" === c.zc.layout() && (c.wk(c.nav.scroll), c.wk(c.divTimeScroll)), c.la(), c.yj(), c.xk(), c.t.drawArea = null
    }, this.yk = null, this.ii = null, this.zk = function() {
     c.watchWidthChanges && (c.ii || (this.ii = setInterval(function() {
      return c.nav && c.nav.top ? (c.yk || (c.yk = {}, c.yk.counter = 0, c.yk.changed = !1, c.yk.width = c.nav.top.offsetWidth), c.yk.width !== c.nav.top.offsetWidth && (c.yk.changed = !0, c.yk.counter = 0, c.yk.width = c.nav.top.offsetWidth), c.yk.changed && (c.yk.counter += 1), void(c.yk.changed && c.yk.counter > 2 && (c.yk.changed = !1, c.fg(), c.qg()))) : void clearInterval(c.ii)
     }, 20)))
    }, this.xk = function() {
     var e = c.rangeHold;
     c.clearSelection(), c.rangeHold = e, c.Kh(e, !0)
    }, this.yj = function() {
     c.A && "Auto" === c.cellWidthSpec && (c._f(), c.ag(), c.dg(), c.hg(), c.kg(), c.ig(), c.lg(), c.O(), c.da(), c.qa(), c.la())
    }, this._f = function() {
     if ("Auto" === this.cellWidthSpec) {
      ...
      if (this.bj()) {
       var a = n / this.bj();
       this.cellWidth = Math.max(a, c.cellWidthMin), c.Og = a < c.cellWidthMin
      }
     }
    }, this.Ak = function() {
     if ("Auto" === c.heightSpec) return 0;
     if ("Max" === c.heightSpec || "Fixed" === c.heightSpec || "Parent100Pct" === c.heightSpec) {
      return c._i() > c.height ? DayPilot.sw(c.nav.scroll) : 0
     }
     ...
     var e = document.createElement("div");
     e.style.overflow = "hidden", e.style.position = "absolute", e.style.display = "block", e.style.top = "0px", e.style.width = "100%", e.style.height = this.Kg() + "px", e.style.overflow = "hidden", e.onmousemove = function() {
      c.U(), c.cellBubble && c.cellBubble.delayedHide()
     }, this.wk(e), this.divTimeScroll = e;
     var t = document.createElement("div");
     return t.style.width = this.bj() * this.cellWidth + 5e3 + "px", this.divNorth = t, e.appendChild(t), e
    }, this.cc = function() {
     var e = 0,
      t = c.heightSpec;
     return "Fixed" === t || "Parent100Pct" === t ? this.height ? this.height : 0 : (e = c._i(), ("Max" === t || "Max100Pct" === t) && e > c.height ? c.height : e)
    }, this.Bk = null, this.Ck = 0, this.Dk = 0, this.Ek = 0, this.Qg = function() {
     if ("function" == typeof c.onHeightChanged || "function" == typeof c.onDimensionsChanged) {
      c.Bk && clearTimeout(c.Bk);
      var e = function() {
       ...
       var a = c.Lg(),
        o = c.Ek;
       if (c.Ek = a, "function" == typeof c.onHeightChanged && e !== t) {
        var r = {};
      ...
      c.Bk = setTimeout(e, 100)
     }
    }, this._i = function() {
     var e;
     return this.Yf !== -1 ? (e = this.Yf, this.Yf > 0 && "auto" === c.nav.scroll.style.overflowX && (e += DayPilot.sh(c.nav.scroll))) : e = this.rowlist.length * this.zc.eventHeight(), e
    }, this.U = function() {
     this.V(), this.Fk(), this.Gk(), this.rj(), this.$i(), c.cellBubble && c.cellBubble.hideOnMouseOut(), c.bubble && c.bubble.hideOnMouseOut()
    }, this.qk = function() {
     var e = document.createElement("div");
     if (e.style.overflow = "auto", e.style.overflowX = "auto", e.style.overflowY = "auto", e.style.position = "absolute", e.style.height = this.cc() + "px", e.style.top = this.Kg() + 1 + "px", e.style.width = "100%", e.className = this.q("_scrollable"), e.oncontextmenu = function() {
       return !1
      }, this.wk(e), c.overrideWheelScrolling) {
      var t = c.scrollStep;
    ...
    C.create = function() {
     ...
     this.nav.scroll.root = this, this.nav.scroll.onscroll = this.qg, c.cj = this.nav.scroll.scrollLeft, c.aj = this.nav.scroll.scrollTop, c.dj = this.divNorth.clientWidth
    }, this.Cf = function() {
     if (this.nav.state) {
      var e = {};
    ...
    }, this.Ok = {}, this.Ok.step = 300, this.Ok.delay = 10, this.Ok.mode = "display", this.Ok.layers = !1, this.fj = function(e) {
    ...
    S.loadRow = function(e) {
     ...
     DayPilot.list(c.rowlist).each(function(i) {
      ...
      var a = i.height;
      i.height = i.getHeight(), n > c.rowMarginTop && (i.height = n + c.rowMarginBottom), a !== i.height && (c.Bh = !0), t += i.height
     }), c.Yf = t
     ...
     S.drawEventsWithoutCheckingOverflow(), S.checkOverflow(), c.gg(), c.la()
     ...
     if (c.cellStackingAutoHeight) {
      ...
      }), e && (c.O(), S.calculateEventPositions(), S.drawEventsWithoutCheckingOverflow(), c.hg(), c.kg())
     }
     ...
     if (!c.Kd) {
      ...
      var t = this.Ok.step;
      this.Ok.layers && (c.divEvents = document.createElement("div"), c.divEvents.style.position = "absolute", c.ug.insertBefore(this.divEvents, this.divSeparatorsAbove)), "display" === this.Ok.mode ? this.divEvents.style.display = "none" : "visibility" === this.Ok.mode && (this.divEvents.style.visibility = "hidden"), this.divEvents.setAttribute("role", "region"), this.divEvents.setAttribute("aria-label", "scheduler events");
      for (var i = "Progressive" === this.dynamicEventRendering, n = this.zg(), a = n.pixels.top, o = n.pixels.bottom, r = c.allowMultiMove || c.allowMultiResize, l = 0; l < this.rowlist.length; l++) {
      ...
      this.divEvents.style.display = "", DayPilot.list(c.multiselect.list).isEmpty() || c.multiselect.redraw(), this.Cg(), v.load()
     }
    }, this.Dh = function(e) {
     var t = this.rowlist[e];
     if (c.cellStacking) return void S.drawEventsRow(t);
     this.divEvents = document.createElement("div"), this.divEvents.style.position = "absolute", this.divEvents.style.display = "none", this.ug.insertBefore(this.divEvents, this.divSeparatorsAbove);
     ...
     if (this.elements.events) {
      for (var t = this.elements.events.length, i = [], n = 0; n < t; n++) {
       ...
       a.event.part.dayIndex === e && (this.yi(a), i.push(n))
      }
     ...
     if ("Progressive" === this.dynamicEventRendering) {
      if (c.dynamicEventRenderingCacheSweeping) {
       ...
       for (var t = [], i = 0, n = this.elements.events.length, a = n - 1; a >= 0; a--) {
        ...
        this.Rk(o.event) ? e > 0 ? (e--, t.unshift(o)) : (this.yi(o), i++) : t.unshift(o)
       }
       this.elements.events = t, this.divEvents.style.display = ""
      }
     }
    }, this.Sk = function(e) {
     for (var t = [], i = 0, n = this.zg(), a = this.elements.cells.length, o = a - 1; o >= 0; o--) {
      var r = this.elements.cells[o];
      n.xStart < r.coords.x && r.coords.x <= n.xEnd && n.yStart < r.coords.y && r.coords.y <= n.yEnd ? t.unshift(r) : e > 0 ? (e--, t.unshift(r)) : (this.Fi(r), i++)
     }
    }, this.Fi = function(e) {
     if (e) {
      var t = e.coords.x,
    ...
    }, this.Nj = DayPilot.list(), this.Vk = function(e) {
     if (e.rendered) return !1;
     ...
     return l.innerHTML = r.group.html, o.appendChild(l), o.onmousedown = function(e) {
      ...
      DayPilot.list(t.events).each(function(e) {
       n.push(e.id())
      }), c.lh(), c.mh(t.part.dayIndex), c.la();
      var e = e || window.event;
      e.cancelBubble = !0
     ...
     if (c.groupConcurrentEvents) {
      var t = e.part.block;
      if (t.events.length > 1 && !t.expanded) return c.Vk(t)
     }
     ...
     var t = this;
     DayPilot.Areas.hideAreas(t, e), DayPilot.Util.removeClass(t, c.q("_event_hover")), c.Xk(t), s.source || v.hideLinkpointsWithDelay(), c.bubble && "Bubble" === c.eventHoverHandling && c.bubble.hideOnMouseOut()
    }, this.Yk = function(e) {
     ...
     if (!t.active) {
      ...
      o && o.length > 0 && (n = n.concat(o)), DayPilot.Areas.showAreas(t, t.event, null, n), DayPilot.Util.addClass(t, c.q("_event_hover")), c.Yk(t)
     }
     "Disabled" === c.linkCreateHandling || s.source || (v.clearHideTimeout(), v.hideLinkpoints(), c.Mk() && v.showLinkpoint(t)), e.srcElement ? e.srcElement.insideEvent = !0 : e.insideEvent = !0
    }, this.$k = {};
    var A = this.$k;
    this.Wk = function(e) {
    ...
    "undefined" == typeof DayPilot.Global.touch && (DayPilot.Global.touch = {}), DayPilot.Global.touch.active = !1, DayPilot.Global.touch.start = !1, T.timeouts = [], T.onEventTouchStart = function(e) {
     ...
     if (!(DayPilot.Global.touch.active || DayPilot.Global.touch.start || e.touches.length > 1 || "Disabled" === c.timeRangeSelectedHandling)) {
      ...
      T.timeouts.push(window.setTimeout(function() {
       DayPilot.Global.touch.active = !0, DayPilot.Global.touch.start = !1, e.preventDefault(), c.coords = T.relativeCoords(e), T.range = c._k()
      }, t));
     ...
     if (DayPilot.Global.touch.active) {
      if (n.moving) {
       ...
       if (DayPilot.Util.removeClass(n.moving, c.q(c.al.eventMovingSource)), DayPilot.de(n.movingShadow), c.rj(), n.movingShadow.calendar = null, document.body.style.cursor = "", n.moving = null, n.movingEvent = null, n.movingShadow = null, c.mj.clear(), l || s || c.mj.forbidden || c.mj.invalid) return;
       c.Xa(t, i, a, o, r)
      }
      if (T.range) {
       var d = T.range;
       ...
       h && h.overlapping ? c.clearSelection() : c.Hh(d)
      }
     ...
     var i = DayPilot.abs(e);
     n.moveOffsetX = t.x - i.x, n.moveDragStart = c.getDate(c.coords.x, !0), n.movingShadow = c.wa(e), c.Zi()
    }, T.startResizing = function(e, t) {
     n.resizing = e, n.resizingEvent = e.event, n.resizing.dpBorder = t, n.resizingShadow || (n.resizingShadow = c.wa(e)), c.nj()
     ...
     if (n.movingShadow && n.movingShadow.calendar !== c && c.rj(), !n.movingShadow) {
      var e = n.moving;
     ...
     if (this.timeHeader) {
      ...
      for (var t = 0; t < this.timeHeader.length; t++)
       for (var i = this.timeHeader[t], n = 0; n < i.length; n++) this.dl(n, t);
      var a = this.divNorth;
    ...
    this.dl = function(e, t) {
     ...
     h.style.position = "absolute", h.style.top = s + "px", h.style.left = o + "px", h.style.width = r + "px", h.style.height = d + "px", n.toolTip && (h.title = n.toolTip), h.setAttribute("aria-hidden", "true"), n.cssClass && DayPilot.Util.addClass(h, n.cssClass), h.setAttribute("unselectable", "on"), h.style.KhtmlUserSelect = "none", h.style.MozUserSelect = "none", h.style.webkitUserSelect = "none", h.oncontextmenu = function() {
      return !1
     }, h.cell = {}, h.cell.start = n.start, h.cell.end = n.end, h.cell.level = t, h.cell.th = n, h.onclick = this.Lj, h.style.overflow = "hidden", c.timeHeaderTextWrappingEnabled || (h.style.whiteSpace = "nowrap");
     var u = document.createElement("div");
     ...
     for (var e = 0; e < this.rowlist.length; e++) {
      ...
      t.height !== i && (this.Bh = !0), t.height = i
     }
    }, this.gg = function() {
     ...
     this.zj && c.nav.resScrollSpace && (c.nav.resScrollSpace.style.top = c.Yf + "px")
    }, this.dd = function(e) {
     ...
     if (!(i.getTime() < this.Da().getTime() || i.getTime() >= this.Zg().getTime())) {
      var l = this.getPixels(i);
      if (!l.cut && !(l.left < 0 || l.left > this.bj() * this.cellWidth)) {
       var s = document.createElement("div");
       s.style.width = a + "px", s.style.height = c.Yf + "px", s.style.position = "absolute", s.style.left = l.left - 1 + "px", s.style.top = "0px", s.style.backgroundColor = n, s.style.opacity = r / 100, s.style.filter = "alpha(opacity=" + r + ")", o ? this.divSeparatorsAbove.appendChild(s) : this.divSeparators.appendChild(s), this.elements.separators.push(s)
      }
     }
    }, this.Kk = function(e) {
     ...
     if (e = e || window.event, e.stopPropagation && e.stopPropagation(), e.cancelBubble = !0, c.gl(c.coords)) {
      var i = c.Ih(c.rangeHold);
      c.db(i.start, i.end, i.resource)
     } else if (n.range = c._k(), n.range) {
      n.rangeCalendar = c;
      var i = c.Ih(n.range);
     ...
     if (!DayPilot.Global.touch.start && !DayPilot.Global.touch.active) {
      if (n.timeRangeTimeout, 1, c.hl(), c.Fk(), !c.coords) {
       var t = c.ug;
       c.coords = DayPilot.mo3(t, e)
      }
      ...
      e = e || window.event;
      var i = DayPilot.Util.mouseButton(e);
      if (i.middle || i.right && c.gl(c.coords)) return !1;
      if (c.gl(c.coords)) return !1;
      var a = e.ctrlKey,
       o = e.metaKey,
       r = e.shiftKey,
       l = a || o,
      ...
      var h = c.fi(c.coords.y).i;
      return !c.rowlist[h].isNewRow && (n.range = c._k(), n.range && (n.range.ctrl = l, n.rangeCalendar = c), !1)
     }
    }, this._k = function() {
     var e = {},
      t = this.bh(c.coords.x).x;
     return e.start = {
      y: c.fi(c.coords.y).i,
      x: t
     }, e.end = {
      x: t
     }, this.li(c.fi(c.coords.y).i) ? null : (e.calendar = c, c.Kh(e), e)
    }, this.oj = function() {
     c.Kc();
     ...
     ! function() {
      ...
      if (!o || !i || i.start !== o.start || i.end !== c.lf(o.end)) {
       ...
       var l = {};
       l.event = t, l.start = r.start, l.end = r.end, r.multiresize.splice(0, 0, l), c.il = a, "function" == typeof c.onEventResizing && c.onEventResizing(r), e.allowed = r.allowed;
       var s = r.start,
        d = c.Me(r.end);
       ...
       e.style.left = g + "px", e.style.width = m - g + "px", e.left = g, e.width = m - g, c.pj(n.resizingShadow, r), c.qj(n.resizingShadow, r)
      }
     }()
    }, this.Ik = function(e) {
     ...
     if (!DayPilot.Global.touch.active) {
      ...
      var t = DayPilot.mc(e);
      if (c.coords = DayPilot.mo3(c.ug, e), e.insideMainD = !0, window.event && window.event.srcElement && (window.event.srcElement.inside = !0), A.start) {
       DayPilot.distance(A.originalMouse, t) > 3 && (DayPilot.Util.copyProps(A, n), document.body.style.cursor = "move", A = {})
      }
      if (n.resizing && n.resizingEvent.calendar === c) n.resizing.event || (n.resizing.event = n.resizingEvent), c.kl();
      else if (n.movingEvent && (n.movingEvent.calendar === c || n.movingEvent.calendar.dragOutAllowed)) c.ll();
      else if (n.range && n.range.calendar === c) n.range.moved = !0, c.ml();
      else if (s.source) {
       var i = s.source;
       v.drawShadow(i.coords, c.coords)
      } else n.rectangleSelect && (n.rectangleSelect.moved = !0, M.draw());
      "Disabled" !== c.crosshairType && c.nl(), c.ol();
      var a = e.insideEvent;
      ...
      if (n.drag) {
       if (c.hl(), n.gShadow && document.body.removeChild(n.gShadow), n.gShadow = null, !n.movingShadow && c.coords && c.rowlist.length > 0) {
        if (!n.movingEvent) {
         ...
         if (h) {
          if (c !== h.calendar) {
           ...
           h = new DayPilot.Event(g), h.calendar = f, h.part.duration = f.Oi(p)
          }
         } else {
      ...
      if ("Always" === c.autoScroll || "Drag" === c.autoScroll && (n.moving || n.resizing || n.range)) {
       ...
       var x = D.clientWidth,
        ...
        r = 0,
        _ = 50;
       S && (o = -50 * d(S, C)), T && (o = _ * d(T, C)), E && (r = -50 * d(E, C) / 2), H && (r = _ * d(E, C) / 2), (n.resizing || n.range) && (r = 0), o || r ? c.pl(o, r) : c.Fk()
      }
     }
    }, this.ml = function() {
     var e = n.range;
     ...
     n.resizingShadow || (n.resizingShadow = c.wa(n.resizing)), c.nj()
    }, this.ll = function() {
    ...
    M.start = function() {
     ...
     if (e = c.bh(c.coords.x).x, t = c.fi(c.coords.y).i, !(t >= c.rowlist.length)) {
    ...
    }, this.hover = {}, this.nl = function() {
     var e = this.rl();
     this.hover.cell && this.hover.cell.x === e.x && this.hover.cell.y === e.y || this.Jc()
    }, this.hl = function() {
     this.divCrosshair.innerHTML = "", this.sl = null, this.ul = null
    }, this.V = function() {
     if (this.hl(), this.vl && this.vl.parentNode && (this.vl.parentNode.removeChild(this.vl), this.vl = null), this.wl) {
      for (var e = 0; e < this.wl.length; e++) {
       var t = this.wl[e];
     ...
     var e, t;
     if (c.coords && c.rowlist && c.rowlist.length > 0 && (e = c.bh(c.coords.x).x, t = c.fi(c.coords.y).i, !(t >= c.rowlist.length))) {
      ...
      if ("Full" === i) {
       ...
       if (!r) {
        var r = document.createElement("div");
        r.style.height = c.Yf + "px", r.style.position = "absolute", r.style.top = "0px", r.className = c.q("_crosshair_vertical"), this.sl = r, this.divCrosshair.appendChild(r)
       }
       ...
       if (!r) {
        var r = document.createElement("div");
        r.style.width = d + "px", r.style.height = s + "px", r.style.position = "absolute", r.style.top = l + "px", r.style.left = "0px", r.className = c.q("_crosshair_horizontal"), this.ul = r, this.divCrosshair.appendChild(r)
       }
       r.style.top = l + "px", r.style.height = s + "px"
      }
      var h = this.xl(this.coords.x);
      if (h && this.Xf !== h.x) {
       this.vl && this.vl.parentNode && (this.vl.parentNode.removeChild(this.vl), this.vl = null);
       var s = R.timeHeader(c.timeHeaders.length - 1).height,
        r = document.createElement("div");
       r.style.width = h.cell.width + "px", r.style.height = s + "px", r.style.left = "0px", r.style.top = "0px", r.style.position = "absolute", r.className = c.q("_crosshair_top"), this.vl = r;
       var u = this.divNorth,
      ...
      if (this.Wf !== t) {
       if (this.wl) {
        for (var v = 0; v < this.wl.length; v++) {
         var p = this.wl[v];
       ...
       if (this.wl = [], this.divHeader.rows[t])
        for (var v = 0; v < this.divHeader.rows[t].cells.length; v++) {
         var d = c.Lg(),
          r = document.createElement("div");
         r.style.width = d + "px", r.style.height = n.height + "px", r.style.left = "0px", r.style.top = "0px", r.style.position = "absolute", r.className = c.q("_crosshair_left"), this.wl.push(r), this.divHeader.rows[t].cells[v].firstChild.appendChild(r)
        }
      }
      h && (this.Xf = h.x), this.Wf = t
     }
     ...
     e && e.calendar === c && ! function() {
      ...
      if (r) {
       ...
       if (t || !d || d.start.getTime() !== h.getTime() || d.end.getTime() !== u.getTime() || d.resource !== c.rowlist[o].id) {
        ...
        var p = c.zl(e);
        c.Jh(p, v.start, v.end);
        var g = i(p);
        c.pj(g, v), e.bl = p, e.disabled = !v.allowed, c.qj(g, v), v.start = f.start, v.end = f.end
       }
      }
     }()
    }, this.zl = function(e) {
    ...
    var H = this.Al;
    this.Al.list = [], this.Al.clear = function() {
     DayPilot.de(DayPilot.list(H.list).map(function(e) {
      return e.div
     })), H.list = []
    }, this.Al.add = function(e) {
     e.div = c.elements.range2, c.elements.range2 = null, c.rj(), H.list.push(e)
    }, this.Al.get = function() {
     return DayPilot.list(H.list).map(function(e) {
      return c.Ih(e)
     })
    }, this.Al.dispatch = function() {
     ...
     if (!DayPilot.Global.touch.active && !DayPilot.Global.touch.start) {
      ...
      if (!n.range && !n.rectangleSelect && !(c.rangeHold && c.gl(c.coords) && (t.right || t.middle) || c.li(c.fi(c.coords.y).i))) {
       var i = {},
        a = c.bh(c.coords.x).x;
       i.start = {
        y: c.fi(c.coords.y).i,
        ...
        x: a
       }, i.calendar = c, c.rangeHold = i, c.Hh(i)
      }
     }
    }, this.timeouts = {}, this.timeouts.drawEvents = null, this.timeouts.drawCells = null, this.timeouts.click = null, this.timeouts.resClick = [], this.timeouts.updateFloats = null, this.qg = function(e) {
     c.$f();
     var t = c.nav.scroll;
     if (c.cj = t.scrollLeft, c.aj = t.scrollTop, c.dj = t.clientWidth, c.divTimeScroll.scrollLeft = c.cj, c.divResScroll.scrollTop = c.aj, u.isEnabled() && c.A && "Auto" != c.cellWidthSpec)
      if (u.active) a();
      else {
     ...
     if (c.navigatorBackSync && ! function() {
      ...
      }(), c.dynamicLoading) return c.Cf(), void c.Cl();
     if (c.timeouts.drawEvents && (clearTimeout(c.timeouts.drawEvents), c.timeouts.drawEvents = null), c.scrollDelayEvents > 0 ? c.timeouts.drawEvents = setTimeout(c.Dl(), c.scrollDelayEvents) : c.qa(), c.timeouts.drawCells && (clearTimeout(c.timeouts.drawCells), c.timeouts.drawCells = null), c.scrollDelayCells > 0) c.timeouts.drawCells = setTimeout(c.El(), c.scrollDelayCells);
     else {
      c.El()()
     }
     c.timeouts.updateFloats && (clearTimeout(c.timeouts.updateFloats), c.timeouts.updateFloats = null), c.scrollDelayFloats > 0 ? c.timeouts.updateFloats = setTimeout(function() {
      c.og()
     }, c.scrollDelayFloats) : c.og(), c.onScrollCalled = !0
    }, this.El = function() {
     return function() {
      c && (c.Cf(), c.kg())
     }
     ...
     return function() {
      c && (c.Tk() ? window.setTimeout(function() {
       c.Qk(), window.setTimeout(function() {
        c.qa(!0)
       }, 50)
      }, 50) : c.Cg())
     }
     ...
     this.visible = !0, this.Vf = !0, c.nav.top.style.display = "", this.pa(), this.fg(), this.Di(), c.qg()
    }, this.hide = function() {
     this.visible = !1, this.Vf = !1, c.nav.top.style.display = "none"
    }, this.Fl = function() {}, this.Cl = function() {
     var e = c.nav.scroll;
     c.cj = e.scrollLeft, c.aj = e.scrollTop, c.dj = e.clientWidth, c.divTimeScroll.scrollLeft = c.cj, c.divResScroll.scrollTop = c.aj, c.refreshTimeout && window.clearTimeout(c.refreshTimeout);
     var t = c.scrollDelayDynamic;
     c.refreshTimeout = window.setTimeout(c.Gl(e.scrollLeft, e.scrollTop), t), c.og()
    }, this.Hl = function(e) {
     ...
     if (i) c.da(e);
      ...
      for (var l = 0; l < e.length; l++) {
       ...
       if (h) {
        ...
        var f = c.events.ih(d.ex);
        a = a.concat(f)
       } else u && this.events.list.push(s);
       (h || u) && (a = a.concat(c.events.jh(s)))
      }
      c.kh(a), c.lh()
     }
     c.eg(), c.la(), i ? (c.O(), c.gg(), c.kg(), c.qa()) : c.mh(a, !1, function() {
      t && t(), c.Qk(), c.qa()
     })
     ...
     return c.r() ? function() {
      ...
      if ("function" == typeof c.onScroll) {
       var e = function(e) {
         ...
         c.mg(e.events, t, e.clearEvents, e.remove)
        },
        t = {};
     ...
     for (var d = this.vj(), s = d.start; s < d.end; s++) this.rowlist[s].hidden || this.Ll(s)
    }, this.kg = function() {
     if (!c.Kd) {
      if (c.progressiveRowRendering && this.rh(), null !== this.rowlist && this.rowlist.length > 0) {
       if (this.cellSweeping) {
        var e = this.cellSweepingCacheSize;
        this.Sk(e)
       }
       this.Jl(), this.Ml(), x.Rj()
      }
      this.Bh = !1
     }
    }, this.Ml = function() {
     for (var e = this.zg(), t = e.xStart; t < e.xEnd; t++) {
      t < this.itline.length - 1 && this.itline[t + 1].breakBefore && this.Nl(t)
     }
    }, this.Nl = function(e) {
     var t = "x" + e;
     if (!this.t.breaks[t]) {
     ...
     if (t) {
      ...
      if (!this.t.linesVertical[i]) {
       var n = t.left + t.width - 1,
        a = document.createElement("div");
       a.style.left = n + "px", a.style.top = "0px", a.style.width = "1px", a.style.height = c.Yf + "px", a.style.fontSize = "1px", a.style.lineHeight = "1px", a.style.overflow = "hidden", a.style.position = "absolute", a.setAttribute("unselectable", "on"), a.className = this.q("_matrix_vertical_line"), this.divLines.appendChild(a), this.elements.linesVertical.push(a), this.t.linesVertical[i] = a
      }
     }
    }, this.Yi = function(e) {
     var t = this.rowlist[e],
     ...
     var n = this.Ol(e, t.expanded);
     if (!i)
      for (var a = 0; a < n.length; a++) {
       var o = n[a];
       this.Ch(o)
      }
     if (this.eg(), this.cg(), this.la(), this.$f(), i) {
      for (var a = 0; a < n.length; a++) {
       var o = n[a];
       this.Dh(o)
      }
     ...
     this.Eh(), v.load(), this.hg(), this.kg(), this.qa(), this.Cf(), this.$f();
     var r = this.Oh(t, e);
     i ? this.Xh(r) : this.Wh(r)
    }, this.Kj = function(e) {
     var t = {};
     ...
     var t = this.nav.scroll.scrollWidth,
      ...
      a = i + n;
     return !(e < 0 && i <= 0) && (!(e > 0 && a >= t) && (this.nav.scroll.scrollLeft += e, c.coords.x += e, c.Rl(), !0))
    }, this.Sl = function(e) {
     if (!e) return !1;
     var t = this.nav.scroll.scrollHeight,
      ...
      a = i + n;
     return !(e < 0 && i <= 0) && (!(e > 0 && a >= t) && (this.nav.scroll.scrollTop += e, c.coords.y += e, c.Rl(), !0))
    }, this.Rl = function() {
     n.resizing && n.resizing.event.calendar === c ? c.kl() : n.moving && (n.movingEvent.calendar === c || n.movingEvent.calendar.dragOutAllowed) ? c.ll() : n.range && n.range.calendar === c && c.ml()
    }, this.Pl = function(e, t) {
     if (this.Ql(e) || this.Sl(t)) {
      var i = function(e, t) {
       return function() {
        c.Pl(e, t)
       }
      };
      this.Tl = window.setTimeout(i(e, t), 100)
     }
    }, this.Fk = function() {
     c.Tl && (window.clearTimeout(c.Tl), c.Tl = null)
    }, this.eg = function() {
     ...
     DayPilot.browser.ie && c.Ul(), this.elements.cells = [], this.elements.breaks = [], this.t.cells = [], this.t.breaks = [], this.divCells.innerHTML = "", this.divBreaks.innerHTML = "", c.Dj()
    }, this.Dj = function() {
    ...
    }, this.Vl = 0, this.Wl = DayPilot.list(["html", "cssClass", "backColor", "backImage", "backRepeat", "areas"]), this.Xl = c.Wl.add("business"), this.hf = function(e, t) {
     if (this.A) {
      var i = c.fh(e);
      if (i) {
       var n = e + "_" + t;
       if (!this.t.cells[n]) {
        var a = this.Gi(e, t);
        if (c.gj(e, t), !this.drawBlankCells) {
         var o = !1;
         if (this.Vi(t) ? o = !1 : this.Yl(a, c.Wl) || (o = !0), o) return
        }
        var r = document.createElement("div");
    ...
    }, this.uh = {}, this.Di = function() {
     c.Zl().each(function(e) {
      c.Fh(e)
     }), c.kg()
    }, this.Zl = function() {
     for (var e = DayPilot.list(), t = this.zg(), i = t.xStart, n = t.xEnd - t.xStart, a = t.yStart, o = t.yEnd - t.yStart, r = 0; r < o; r++)
      for (var l = a + r, s = 0; s <= n; s++) {
       var d = i + s;
       if (!this.rowlist[l].hidden && !c.uh[d + "_" + l]) {
        e.push(l);
        break
       }
      }
     ...
     if ("function" == typeof this.onBeforeCellRender) {
      if (c.beforeCellRenderCaching && c.uh[e + "_" + t]) return;
      c.uh[e + "_" + t] = !0;
      var i = c.fh(e);
      if (!i) return;
      ...
      }, this.onBeforeCellRender(a), DayPilot.Util.copyProps(a.cell, a.cell.properties, c.Xl), a
     }
     ...
     if (t) {
      ...
      for (var n in e)
       if (!DayPilot.Util.isNullOrUndefined(e[n])) return !0; return !1
    }, this.clearSelection = function() {
     this.ng(), H.clear()
     ...
     var l = c.dh(new DayPilot.Date(t).addSeconds(-1)),
     ...
     }, d.calendar = this, c.Kh(d), n || setTimeout(function() {
      c.Hh(d)
     }, 0)
    }, this.Gh = function() {
     DayPilot.de(n.movingShadow), n.movingShadow = null, c.rj(), c.mj.clear(), DayPilot.Global.movingLink && (DayPilot.Global.movingLink.clear(), DayPilot.Global.movingLink = null)
    }, this.ng = function() {
     this.divRange.innerHTML = '<div style="position:absolute; left:0px; top:0px; width:0px; height:0px;"></div>', this.elements.range = [], this.elements.range2 = null, this.rj(), c.rangeHold = null
    }, this.zc = {};
    var _ = this.zc;
    ...
    R.timeHeader = function(e) {
     ...
     if (this.Sf && (this.cellProperties[i] = c._l(e, t)), !this.cellProperties[i]) {
      var o = c.rowlist[t],
       r = o.id,
    ...
    }, this.bm = function(e, t, i) {
     var n = t + "_" + i;
     return this.cellProperties[n] = {}, DayPilot.Util.copyProps(e, this.cellProperties[n], c.Xl), this.cellProperties[n]
     ...
     var a = {};
     return DayPilot.Util.copyProps(n, a, c.Xl), a
    }, this.ca = function() {
     if (!this.Sf && !this.Tf && (this.Tf = !0, this.cellConfig)) {
      var e = this.cellConfig;
      if (e.vertical)
       for (var t = 0; t < e.x; t++) {
        var i = this.cellProperties[t + "_0"];
        if (i)
         for (var n = 1; n < e.y; n++) this.bm(i, t, n)
       }
      if (e.horizontal)
       for (var n = 0; n < e.y; n++) {
        var i = this.cellProperties["0_" + n];
        if (i)
         for (var t = 1; t < e.x; t++) this.bm(i, t, n)
       }
      if (e["default"])
       for (var i = e["default"], n = 0; n < e.y; n++)
        for (var t = 0; t < e.x; t++) this.cellProperties[t + "_" + n] || this.bm(i, t, n)
     }
     ...
     e() || c.Xc || (c.Xc = setInterval(function() {
      e() && (clearInterval(c.Xc), c.show(), c.xj())
     }, 100))
    }, this.cm = function(e) {
     "Parent100Pct" !== this.heightSpec && (this.heightSpec = "Fixed"), this.height = e - (this.Kg() + 2), this.la()
    }, this.setHeight = this.cm, this.xg = function(e) {
     ...
     this.md(), this.bg(), this.fg(), this.Zc(), this.S(), n.register(this), this._(this.afterRenderData, !1), this.Nk(), this.ta(), this.H("Init")
    }, this.init = function() {
     return this._b(), this.em(), this.Wc(), this.zk(), this
    }, this.em = function() {
     if (this.xd(), !this.nav.top.dp) {
      this.mk();
      if (this.vd()) return this.dm(), this.A = !0, void this.$f();
      this.Zc(), this.S(), n.register(this), this.Nk(), this.ld(), this.A = !0;
      var angular = c.kd.scope || c.rg.enabled;
      c.scrollToDate ? c.scrollTo(c.scrollToDate) : c.scrollX || c.scrollY ? c.setScroll(c.scrollX, c.scrollY) : angular || c.qg(), c.scrollToResourceId && (c.scrollToResource(c.scrollToResourceId), c.scrollToResourceId = null);
      var e = function() {
      ...
      }, 0), this.ta(), this.$f(), this._(this.afterRenderData, !1), c.initEventEnabled && setTimeout(function() {
       c.H("Init")
      }), this.zd(), this.hi = !0
     }
    }, this.Ad = null, this.od = function(e) {
     if (e) {
      ...
      c.Ad = t, c.rg.scrollToRequested && (t.scrollTo.data = c.rg.scrollToRequested, c.rg.scrollToRequested = null), c.rg.scrollXRequested && (t.scrollX.data = c.rg.scrollXRequested, c.rg.scrollXRequested = null), c.rg.scrollYRequested && (t.scrollY.data = c.rg.scrollYRequested, c.rg.scrollYRequested = null);
      for (var i in e)
       if (t[i]) {
        var n = t[i];
        n.data = e[i], n.preInit && n.preInit()
   ...
   }, o = "2018.1.3158" === (new DayPilot.Scheduler).v, DayPilot.Row = function(e, t) {
    ...
    var a = this;
    a.isRow = !0, a.menuType = "resource", a.start = e.start, a.name = e.name, a.value = e.id, a.id = e.id, a.tags = e.tags, a.bubbleHtml = e.bubbleHtml, a.index = i, a.level = e.level, a.calendar = t, a.data = e.resource, a.gm = e, a.$ = {}, a.$.row = e, a.toJSON = function(e) {
     var t = {};
     return t.start = this.start, t.name = this.name, t.value = this.value, t.id = this.id, t.index = this.index, t
    }, a.parent = function() {
     return a.gm.ik ? t.Oh(a.gm.ik) : null
    }, a.children = function() {
     var e = DayPilot.list(a.$.row.children).map(function(e) {
      return t.Oh(t.rowlist[e])
     });
     ...
     for (var e = DayPilot.list(), t = 0; t < a.gm.events.length; t++) e.push(a.gm.events[t]);
     return e
    }, a.events.isEmpty = function() {
     return 0 === a.gm.events.length
    }, a.events.forRange = function(e, t) {
     return a.gm.events.forRange(e, t)
     ...
     for (var e = 0; e < a.gm.blocks.length; e++) {
      new o(a.gm.blocks[e]).hm()
     }
     t.lh(), t.mh(a.index), t.la()
    }, a.groups.expandAll = function() {
     for (var e = 0; e < a.gm.blocks.length; e++) {
      new o(a.gm.blocks[e]).im()
     }
     t.lh(), t.mh(a.index), t.la()
    }, a.groups.expanded = function() {
     for (var e = [], i = 0; i < a.gm.blocks.length; i++) {
      var n = a.gm.blocks[i];
      n.expanded && n.lines.length > t.groupConcurrentEventsLimit && e.push(new o(n))
     }
     return DayPilot.list(e)
    }, a.groups.collapsed = function() {
     for (var e = [], t = 0; t < a.gm.blocks.length; t++) {
      var i = a.gm.blocks[t];
    ...
    var o = function(e) {
      ...
      this.im = function() {
       ...
       this.im(), t.lh(), t.mh(e.row.index), t.la()
      }, this.hm = function() {
       if (e.lines.length > t.groupConcurrentEventsLimit) {
        ...
        t.Nj = t.Nj.filter(function(e) {
         return !DayPilot.contains(i, e)
        })
       }
      }, this.collapse = function() {
       this.hm(), t.lh(), t.mh(e.row.index), t.la()
      }
     },
     r = function(e, t) {
    ...
    if (n.drag && n.drag.schedulerSourceEvent) {
     var e = n.drag.schedulerSourceEvent,
      t = e.event.calendar;
     DayPilot.Util.removeClass(e, t.q(i.al.eventMovingSource))
    }
    if (n.dragStop(), n.resizing && (DayPilot.de(n.resizingShadow), n.resizing = null, n.resizingEvent = null, n.resizingShadow = null), n.moving) {
     ...
     DayPilot.Util.removeClass(n.moving, i.q(i.al.eventMovingSource)), DayPilot.de(n.movingShadow), n.moving = null, n.movingEvent = null, n.movingShadow = null
    }
    if (n.range) {
      ...
      function() {
       if (a.dragOutAllowed) {
        ...
        if (!t || t !== a) {
         ...
         n.drag = {};
         var r = n.drag;
         r.id = o.id(), r.text = o.text(), r.schedulerSourceEvent = n.moving, r.element = null, r.duration = (o.rawend().getTime() - o.start().getTime()) / 1e3, r.text = o.text(), r.id = o.id(), r.event = DayPilot.Util.copyProps(o), a.rj(), DayPilot.de(n.movingShadow), n.movingShadow.calendar = null, n.movingShadow = null, n.registered.out()
        }
       }
      }()
    }
    ...
    if ("undefined" != typeof n && !(DayPilot.Global.touch.active || DayPilot.Global.touch.start || (e = e || window.event, e.insideMainD || e.srcElement && e.srcElement.inside))) {
     ...
     if (n.drag) {
      ...
      if (l.style.left = t.x + "px", l.style.top = t.y + "px", n.moving = null, n.movingEvent = null, n.movingShadow) {
       ...
       s && s.rj(), n.movingShadow.calendar = null, DayPilot.de(n.movingShadow), n.movingShadow = null
      }
      ...
      var d = n.drag;
      d.schedulerSourceEvent = n.moving, d.element = null, d.duration = (e.rawend().getTime() - e.start().getTime()) / 1e3, d.text = e.text(), d.id = e.value(), d.event = DayPilot.Util.copyProps(e), s.rj(), DayPilot.de(n.movingShadow), n.movingShadow.calendar = null, n.movingShadow = null
     }
     n.registered.out()
    }
    ...
    var e = e || window.event;
    17 === e.keyCode && n.rangeCalendar && n.rangeCalendar.Al.dispatch()
    ...
    if (DayPilot.list(n.registered).each(function(e) {
     ...
     var t = function() {
      var e = n.resizingEvent,
       t = e.calendar;
      document.body.style.cursor = "", n.resizing = null, n.resizingEvent = null, DayPilot.de(n.resizingShadow), n.resizingShadow = null, t.Fl()
     };
     ...
     if (o.rj(), o.jj.clear(), t(), c || h) return;
     o.Ua(i, r, d)
    } else if (n.movingEvent) {
     var t = function() {
      DayPilot.Global.movingAreaData = null;
      var e = n.movingShadow && n.movingShadow.calendar;
      n.movingShadow && (DayPilot.de(n.movingShadow), n.movingShadow.calendar = null), document.body.style.cursor = "", n.moving = null, n.movingEvent = null, n.drag = null, e.Fl(), e && (e.Lc = null)
     };
     if (!n.movingShadow) return void t();
     var i = n.movingEvent,
      o = n.movingShadow.calendar;
     if (!o) return void t();
     if (DayPilot.Util.removeClass(n.moving, o.q(o.al.eventMovingSource)), function() {
       if (n.drag && n.drag.schedulerSourceEvent) {
        var e = n.drag.schedulerSourceEvent,
         t = e.event.calendar;
        DayPilot.Util.removeClass(e, t.q(o.al.eventMovingSource))
       }
     ...
     if (n.drag && (o.todo || (o.todo = {}), o.todo.del = n.drag.element, n.drag = null), n.movingShadow.calendar = null, document.body.style.cursor = "", n.moving = null, n.movingEvent = null, c || h || o.mj.forbidden || o.mj.invalid) return void o.Gh();
     var e = e || window.event;
     ...
     if (o.allowMultiRange) return o.elements.range2.overlapping ? (DayPilot.de(o.elements.range2), o.elements.range2 = null, o.rj()) : o.Al.add(g), n.range = null, m || o.Al.dispatch(), void t();
     ...
     var y = function(e) {
       return function() {
        ...
        return t && t.overlapping ? void o.clearSelection() : (o.Hh(e), void("Hold" !== o.timeRangeSelectedHandling && "HoldForever" !== o.timeRangeSelectedHandling ? a() : o.rangeHold = e))
       }
      },
      b = o.zl(g);
     ...
     var o = s.calendar;
     o.mi.clearShadow(), o.mi.hideLinkpoints(), s.source = null, s.calendar = null
    } else if (n.splitting) {
     var w = n.splitting;
     ...
     var D = n.rectangleSelect,
      o = D.calendar;
     if (!D.moved) return n.rectangleSelect = null, void(o.gl(o.coords) || o.Bl(e));
     var k = D.x,
      x = D.y,
      P = D.width,
      C = D.height,
      S = !1,
      A = o.Dg.eventsInRectangle(k, x, P, C).map(function(e) {
       return e.event
      });
     if ("function" == typeof o.onRectangleEventSelect) {
      ...
      if (T.events = A, T.append = !1, T.start = o.getDate(k, !0), T.end = o.getDate(k + P, !0), T.preventDefault = function() {
        this.preventDefault.value = !0
       }, o.onRectangleEventSelect(T), T.preventDefault.value) return o.ql.clear(), void(n.rectangleSelect = null);
      S = T.append
     }
     if (S || o.multiselect.clear(!0), A.each(function(e) {
       o.multiselect.add(e, !0)
      }), o.multiselect.redraw(), setTimeout(function() {
       o.ql.clear(), n.rectangleSelect = null
    ...
    if (n.drag && (n.drag.event && n.drag.event.part && delete n.drag.event.part.external, n.drag = null, document.body.style.cursor = ""), n.gShadow) {
     if (n.gShadow.source) {
      ...
      DayPilot.Util.removeClass(n.gShadow.source, o.q(o.al.eventMovingSource))
     }
        ...
        return t[0].removeAttribute("id"), t[0].innerHTML = this["template"].replace("{{id}}", i["id"]),
         function(t, i, n) {
          ...
          c || a.init(), d.call(t, c, function(e, t) {
           a.od(e), a.A ? (a.update(), a.zd()) : a.init()
...
"undefined" == typeof DayPilot.Global && (DayPilot.Global = {}),
 function() {
  "undefined" == typeof DayPilot.Year && (DayPilot.Year = function(e, t) {
   this.v = "2018.1.3158";
   this.startDate = new DayPilot.Date, this.cssOnly = !0, this.cssClassPrefix = null, this.columns = 4, this.cellWidth = 20, this.showWeekNumbers = !1, this.jm = [], this.of = function() {
    this.root.dp = this, this.fe = new DayPilot.Date(this.startDate.toString("yyyy-01-01", "en-us"))
   }, this.q = function(e) {
    ...
    var e = this.columns,
     t = 12 / e;
    this.root.className = this.q("_main"), this.root.style.width = e * (7 * this.cellWidth + this.pf()) + "px";
    for (var i = 0; i < t; i++) {
     for (var n = 0; n < e; n++) {
      var a = i * e + n,
       o = o + "_nav_" + a,
      ...
      l.startDate = this.fe.addMonths(a), l.cssOnly = this.cssOnly, l.cssClassPrefix = this.cssClassPrefix, l.cellWidth = this.cellWidth, l.showWeekNumbers = this.showWeekNumbers, l.internal.showLinks = {}, l.selectMode = "none", l.timeRangeSelectedHandling = "JavaScript", l.onTimeRangeSelected = this.lm, l.init(), l.root.className = "", this.jm.push(l)
     }
     var s = document.createElement("div");
    ...
    if (this.root = document.getElementById(e), !this.root.dp) return this.of(), this.km(), this
   }
  })
 }();